...
/client/proc/force_dark_theme() //Inversely, if theyre using white theme and want to swap to the superior dark theme, let's get WINSET() ing
	...
	winset(src, "wikiurl", "text-color = #000000;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "discordurl", "background-color = none;background-color = #494949")
	winset(src, "discordurl", "text-color = #000000;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "githuburl", "background-color = none;background-color = #3a3a3a")
	winset(src, "githuburl", "text-color = #000000;text-color = [COLOR_DARKMODE_TEXT]")
	//Status and verb tabs
