...
/obj/machinery/suit_cycler/attackby(obj/item/I, mob/user)
	...
	if(I.get_tool_type(usr, list(QUALITY_SCREW_DRIVING)))
		...
		if(I.use_tool(user, src, WORKTIME_NEAR_INSTANT, QUALITY_SCREW_DRIVING, FAILCHANCE_VERY_EASY, required_stat = STAT_PRD, instant_finish_tier = 30, forced_sound = used_sound))
