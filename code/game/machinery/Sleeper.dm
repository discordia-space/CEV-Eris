/obj/machinery/sleeper
	...
	var/list/available_chemicals = list("inaprovaline" = "Inaprovaline", "stoxin" = "Soporific", "paracetamol" = "Paracetamol", "anti_toxin2" = "Synth-Dylovene", "dexalin" = "Dexalin", "tricordrazine" = "Tricordrazine")
