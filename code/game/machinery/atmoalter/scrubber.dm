...
/obj/machinery/portable_atmospherics/powered/scrubber/nano_ui_interact(mob/user, ui_key = "rcon", datum/nanoui/ui, force_open = NANOUI_FOCUS)
	var/list/data[0]
...
/obj/machinery/portable_atmospherics/powered/scrubber/huge/stationary/attackby(obj/item/I, mob/user)
	if(QUALITY_BOLT_TURNING in I.tool_qualities)
