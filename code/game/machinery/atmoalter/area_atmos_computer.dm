...
/obj/machinery/computer/area_atmos/proc/validscrubber(obj/machinery/portable_atmospherics/powered/scrubber/huge/scrubber)
	if(!isobj(scrubber) || get_dist(scrubber.loc, loc) > range || scrubber.loc.z != loc.z)
		return 0
	return 1
...
/obj/machinery/computer/area_atmos/validscrubber(obj/machinery/portable_atmospherics/powered/scrubber/huge/scrubber)
	if(!istype(scrubber))
		return FALSE
...
/obj/machinery/computer/area_atmos/scanscrubbers()
	...
	if(!T.loc) return
	var/area/A = T.loc
	for(var/obj/machinery/portable_atmospherics/powered/scrubber/huge/scrubber in SSmachines.processing)
