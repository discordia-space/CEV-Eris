...
/obj/machinery/alarm/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = NANOUI_FOCUS, var/master_ui = null, var/datum/ui_state/state = GLOB.default_state)
	var/data[0]
...
/obj/machinery/firealarm/nano_ui_interact(var/mob/user, var/ui_key = "main", var/datum/nanoui/ui = null, var/force_open = NANOUI_FOCUS, var/datum/ui_state/state = GLOB.notcontained_state)
	var/data[0]
	var/decl/security_state/security_state = decls_repository.get_decl(GLOB.maps_data.security_state)
