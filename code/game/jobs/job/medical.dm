/datum/job/cmo
	title = "Morbius Not Organ Harvester"
	flag = MBO
	head_position = 1
	...
	description = "You are the head of the Morbius Medical branch, contracted by the captain to provide medical services to the crew.<br>\
...
The handling of the medbay is your domain, although remember that both medical and science are branches of Morbius corp, so your colleagues have free access to your resources, and vice versa"
...
Your second loyalty is to your career with Morbius corp, and to your coworkers in both branches of moebius. Help out your scientific colleagues, and aid in their pursuit of knowledge."

/obj/landmark/join/start/cmo
	name = "Morbius Not Organ Harvester"
...
/datum/job/doctor
	...
	total_positions = 5
	spawn_positions = 5
	supervisors = "the Morbius Not Organ Harvester"
...
/datum/job/chemist
	...
	<br>\
	Your secondary responsibility is as a chemical manufacturer for morbius generally. You may be requested to make non-medical chemicals for your colleagues in science, or even for other medical staff. Anyone within morbius should be freely and quickly provided with anything they request. Don't question why, it's above your paygrade.<br>\
	<br>\
	Your third duty is to run a chemical sales outlet. You may get requests from other crewmembers to make acid, chemical grenades, smoke, cleaning products, napalm, or perhaps even just to make medicines. You are fully licensed to sell any and all chemicals to those outside moebius. Sell being the operative word here. If someone isn't an employee of Morbius corp, charge them for their chemicals.<br>\
	<br>\
	...
	duties = "		Mix medicines for doctors<br>\
		Fill chemical requests for morbius staff<br>\
		Sell chemicals and chem grenades to outsiders"

	loyalties = "Your loyalty is to your career with Morbius corp, and to your coworkers in both branches of moebius. Help out your scientific colleagues, and aid in their pursuit of knowledge."


/obj/landmark/join/start/chemist
	name = "Morbius Powergamer"
	icon_state = "player-green"
...
/datum/job/paramedic
	...
	description = "You are a Morbius Hobo, The hero of the hour! While doctors largely spend their time cloistered away in medbay, your job is to be out there on the frontlines. You work in the field, sometimes treating people on the spot, sometimes bringing them back to medical for specialist treatment. <br>\
...
<br>\
Character Expectations:<br>\
Hobo is a physically demanding job, your character must be fit and strong. No fat bodies allowed<br>\
...
Remember that you are a noncombatant. Any weapons you carry should be used for breaching and rescue, not for killing. Use violence only as a last resort to defend yourself or your patient"
	...
	<br>\
	Your second loyalty is to your immediate superior, the Morbius Not Organ Harvester. Follow their instructions and policies.<br>\
	<br>\
	Your third loyalty is to your fellow colleagues in Moebius, especially those in Morbius medical. You are the lowest ranked personnel in the medbay, and you take orders from everyone else working there."
...
/datum/job/bioengineer
	title = "Morbius Definitely Organ Harvester"
	flag = BIOENGINEER
	department = DEPARTMENT_MEDICAL
	department_flag = MEDICAL
	faction = "CEV Eris"
	...
	description = "You are a visionary. Your work lies on the bleeding edge of the medical sciences.<br>\
					...
					<br>\
						...
						<br>\
					You have full access to Morbius medical facilities, and can utilize them if medical is short staffed. \
...
/obj/landmark/join/start/bioengineer
	name = "Morbius Definitely Organ Harvester"
	icon_state = "player-green"
