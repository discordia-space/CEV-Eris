/datum/job/cmo
	...
	req_admin_notify = 1
	also_known_languages = list(LANGUAGE_CYRILLIC = 10, LANGUAGE_SERBIAN = 5, LANGUAGE_NEOHONGO = 100)
	wage = WAGE_COMMAND
...
/datum/job/doctor
	...
	also_known_languages = list(LANGUAGE_CYRILLIC = 10, LANGUAGE_NEOHONGO = 100)
...
/datum/job/paramedic
	...
	also_known_languages = list(LANGUAGE_CYRILLIC = 20, LANGUAGE_SERBIAN = 15, LANGUAGE_NEOHONGO = 100)
