...
/datum/job/artist
	...
	description = "You are a creative soul aboard this vessel. You have been brought onto this ship to create masterful works of art to be sold at mind-boggling prices... and something about the CEV Eris and it's doomed journey sparks the fire of creation within you.<br>\
	...
	You can gain desires by spending this insight at your Artist's Bench to build a work of art, this art you create vary wildly in type, quality, and value. Sell your artwork to the unwashed masses, or give you work to the manager to sell for a profit."
