...
/datum/job/gunserg
	...
	also_known_languages = list(LANGUAGE_CYRILLIC = 25, LANGUAGE_SERBIAN = 25, LANGUAGE_NEOHONGO = 100)
...
/datum/job/inspector
	...
	also_known_languages = list(LANGUAGE_CYRILLIC = 50, LANGUAGE_SERBIAN = 50, LANGUAGE_NEOHONGO = 60)
...
/datum/job/medspec
	...
	selection_color = "#a7bbc6"
	wage = WAGE_PROFESSIONAL
	also_known_languages = list(LANGUAGE_CYRILLIC = 5, LANGUAGE_NEOHONGO = 60)
