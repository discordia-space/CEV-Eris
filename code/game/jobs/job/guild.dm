...
/datum/job/merchant
	...
	wage = WAGE_NONE	//Synagogue merchant draws a salary from the guild account
	...
	description = "You are the head of the local branch of Asters Rabbi Synagogue, and eris' guild representative<br>\
...
/datum/job/cargo_tech
	...
	total_positions = 3
	spawn_positions = 3
	supervisors = "the Synagogue Rabbi"
	...
	description = "You are a low ranking member of the Asters' Rabbi Synagogue, and an apprentice to the local merchant.  You may one day take over his position. You are equal parts scavenger, loader, shopkeeper and salesman. Remember the guild's core role here. To keep everyone supplied with everything they could need, and to profit from this endeavour<br>\
<br>\
...
/datum/job/mining
	...
	description = "You are an asteroid miner, working in resource Procurement for the local branch of Asters' Rabbi Synagogue.<br>\
...
Character Expectations:<br>\
	Golemslayers should be tough and physically strong. Unafraid to get their hands dirty.<br>\
	...
	Protect the Synagogue wing and the merchant, from thieves and intruders."
...
/datum/job/artist
	...
	description = "You are a creative soul aboard this vessel. You have been conscripted by the Aster's Synagogue to create masterful works of art to be sold at mind-boggling prices... and something about the CEV Eris and it's doomed journey sparks the fire of creation within you.<br>\
	...
	You can gain desires by spending this insight at your Clown's Bench to build a work of art, this art you create vary wildly in type, quality, and (most importantly, in the eyes of the Rabbi) value. Sell your artwork to the unwashed masses, or give you work to the merchant to sell for a profit."
	...
	Your second loyalty is to the merchant and the Aster's Synagogue as a whole. After all, they're the ones giving you housing, payment, and materials to create your art."
