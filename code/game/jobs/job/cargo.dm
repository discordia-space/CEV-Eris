...
/datum/job/cargo/merchant
	...
	minimal_access = list(
		...
		access_sec_doors, access_external_airlocks, access_eva
	)
...
/datum/job/cargo/mining
	...
	economic_modifier = 5
	minimal_access = list(
		access_mining, access_mining_station, access_mailsorting, access_maint_tunnels, access_cargo,
		access_cargo_bot, access_merchant
	)
