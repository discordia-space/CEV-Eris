...
/datum/effect/system/trail
	var/obj/effect/trail_effect = /obj/effect/trail_particle/gasjet
	var/active = FALSE
...
/datum/effect/system/trail/set_up(var/atom/_holder, var/obj/item/weapon/tank/jetpack/J)
	attach(_holder)
	if (J)
		jetpack = J
	else
...
/datum/effect/system/trail/start()
	...
	GLOB.moved_event.register(holder, src, /datum/effect/system/trail/proc/holder_moved)

	active = TRUE


/datum/effect/system/trail/proc/holder_moved(var/atom/A, var/atom/old_loc)
...
/datum/effect/system/trail/proc/do_effect(var/turf/eloc, var/newdir)
	var/obj/effect/E = new trail_effect(eloc)
	E.set_dir(newdir)
	return E

/datum/effect/system/trail/proc/stop()
	GLOB.moved_event.unregister(holder, src, /datum/effect/system/trail/proc/holder_moved)
	active = FALSE
...
/datum/effect/system/trail/ion
	trail_effect = /obj/effect/ion_trails
...
**************************************************************/
/datum/effect/system/trail/jet
	trail_effect = /obj/effect/trail_particle/gasjet

//Only do a thrust if the holder has the done var set false, and is also turned on
/datum/effect/system/trail/jet/holder_moved(var/atom/A, var/atom/old_loc)
