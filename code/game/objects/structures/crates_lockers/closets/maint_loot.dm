...
/obj/structure/closet/random/miscellaneous/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/contraband/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/contraband/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/rare/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junk(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junk(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junk(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/cloth/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/cloth/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_adjacent_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_adjacent_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_adjacent_loot/low_chance(NULLSPACE))
...
/obj/structure/closet/random/tech/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/low_chance(NULLSPACE))
...
/obj/structure/closet/random/spareparts/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/techpart(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/techpart(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/techpart(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/techpart(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/techpart(NULLSPACE))
	...
	spawnedAtoms.Add(new /obj/spawner/tool_upgrade(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/tool_upgrade(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lathe_disk(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lathe_disk/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/low_chance(NULLSPACE))
	for(var/atom/movable/a in spawnedAtoms)
		a.forceMove(src)
...
/obj/structure/closet/random/milsupply/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/rare(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/gun_loot/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical/low_chance(NULLSPACE))
	for(var/atom/movable/a in spawnedAtoms)
		a.forceMove(src)
...
/obj/structure/closet/random/medsupply/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical_lowcost(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical_lowcost(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical_lowcost(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical_lowcost(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/medical/low_chance(NULLSPACE))
...
/obj/structure/closet/random/hostilemobs/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/pack/rare(NULLSPACE)) //To reward players for fighting this bullshit
	spawnedAtoms.Add(new /obj/spawner/pack/rare(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/rations(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/rations(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/rations(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/mob/roaches/cluster(NULLSPACE))
	for(var/atom/movable/a in spawnedAtoms)
		a.forceMove(src)
...
/obj/structure/closet/random/hostilemobs/beacon/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/rations(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/rations(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/mob/roaches/cluster/beacon(NULLSPACE))
	for(var/atom/movable/a in spawnedAtoms)
		a.forceMove(src)
