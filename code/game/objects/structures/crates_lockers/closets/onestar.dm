...
/obj/structure/closet/onestar/tier1/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/onestar(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/onestar(NULLSPACE))
...
/obj/structure/closet/onestar/tier2/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/onestar(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/onestar(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/tool/advanced/onestar/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/low_chance(NULLSPACE))
...
/obj/structure/closet/onestar/tier3/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/junk(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/onestar(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/tool/advanced/onestar(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/lowkeyrandom/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/pack/tech_loot/low_chance(NULLSPACE))
