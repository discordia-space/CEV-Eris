...
/obj/structure/closet/secure_closet/warden/populate_contents()
	...
	new /obj/item/clothing/glasses/sunglasses/sechud/tactical(src)
	new /obj/item/storage/belt/tactical/ironhammer(src)
	new /obj/item/clothing/suit/storage/armor/vest/ironhammer(src)
...
/obj/structure/closet/secure_closet/detective/populate_contents()
	...
	new /obj/item/clothing/suit/storage/trenchcoat(src)
	new /obj/item/clothing/suit/storage/trenchcoat/ironhammer(src)
	new /obj/item/clothing/mask/gas/ihs(src)
