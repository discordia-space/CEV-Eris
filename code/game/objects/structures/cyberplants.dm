/obj/structure/cyberplant
	...
	var/global/list/possible_colors = list(
		COLOR_LIGHTING_RED_MACHINERY,
		COLOR_LIGHTING_BLUE_MACHINERY,
		COLOR_LIGHTING_GREEN_MACHINERY,
		COLOR_LIGHTING_ORANGE_MACHINERY,
		COLOR_LIGHTING_PURPLE_MACHINERY,
		COLOR_LIGHTING_CYAN_MACHINERY
	)
