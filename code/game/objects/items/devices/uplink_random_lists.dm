...
/datum/uplink_random_selection/default/New()
	...
	items += new/datum/uplink_random_item(/datum/uplink_item/item/apparel/space_suit, 50, 10)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/tools/thermal)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/apparel/tan_vest)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/apparel/tan_helmet)
