...
/datum/uplink_random_selection/default/New()
	...
	items += new/datum/uplink_random_item(/datum/uplink_item/item/hardsuit_modules/ewar, reselect_propbability = 15)
	items += new/datum/uplink_random_item(/datum/uplink_item/item/hardsuit_modules/voice, reselect_propbability = 15)
