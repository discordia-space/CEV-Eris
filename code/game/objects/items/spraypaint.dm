...
/obj/item/spraypaint/afterattack(atom/target, mob/user as mob, proximity)
	...
	if(istype(target,/turf))
		...
		switch(graffititype)
			...
			if("Onestar")
				new /obj/effect/decal/cleanable/graffiti_onestar(target)
			if("Doodle")
				new /obj/effect/decal/cleanable/graffiti_doodle(target)
			if("Piss")
				new /obj/effect/decal/cleanable/graffiti_piss(target)
			if("Clown")
				new /obj/effect/decal/cleanable/graffiti_clown(target)
			if("Skull")
