/obj/item/weapon/tool/omnitool
	...
	desc = "Fuel powered monster of a tool. Its welder part is most advanced one, capable of welding things without harmfull glow and sparks, so no protection needed."
	icon_state = "omnitool"
