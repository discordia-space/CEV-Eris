...
/obj/item/tool/multitool_improvised
	...
	flags = CONDUCT
	switched_on_qualities = list(QUALITY_CUTTING = 15, QUALITY_DRILLING = 5, QUALITY_SCREW_DRIVING = 15, QUALITY_WIRE_CUTTING = 20, QUALITY_RETRACTING = 10, QUALITY_BONE_SETTING = 10, QUALITY_PRYING = 10, QUALITY_DIGGING = 10,QUALITY_HAMMERING = 10, QUALITY_BOLT_TURNING = 20, QUALITY_SHOVELING = 25, QUALITY_DIGGING = 25, QUALITY_EXCAVATION = 10, QUALITY_SAWING = 15, QUALITY_WELDING = 15, QUALITY_CAUTERIZING = 10)
	degradation = 1.5
	workspeed = 0.8
