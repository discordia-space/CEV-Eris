...
/obj/item/weapon/bluespace_harpoon
	name = "NT BSD \"Harpoon\""
	desc = "One of the last things developed by The Company, this harpoon serve as tool for short and accurate teleportation of cargo and personal through blue-space."
