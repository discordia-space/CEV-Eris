...
/obj/item/storage/freezer/contains_food/populate_contents()
	...
	spawnedAtoms.Add(new /obj/spawner/pizza/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/soda(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/soda/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/rations/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junkfood(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junkfood(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junkfood(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junkfood/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/junkfood/low_chance(NULLSPACE))
	spawnedAtoms.Add(new /obj/spawner/booze/low_chance(NULLSPACE))
	for(var/atom/movable/a in spawnedAtoms)
		a.forceMove(src)
