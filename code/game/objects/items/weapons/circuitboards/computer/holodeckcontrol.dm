...
/obj/item/weapon/electronics/circuitboard/holodeckcontrol
...
/obj/item/weapon/electronics/circuitboard/holodeckcontrol/construct(var/obj/machinery/computer/HolodeckControl/HC)
	if (..(HC))
...
/obj/item/weapon/electronics/circuitboard/holodeckcontrol/deconstruct(var/obj/machinery/computer/HolodeckControl/HC)
	if (..(HC))
