//BIG CELLS - for APC, borgs and69achinery.
/obj/item/cell/large
	...
	matter = list(MATERIAL_STEEL = 3,69ATERIAL_PLASTIC = 3,69ATERIAL_SILVER = 3)
	price_tag = 200
	spawn_tags = SPAWN_TAG_POWERCELL_LARGE

/obj/item/cell/large/high
	name = "Asters \"Robustcell 5000L\""
	desc = "Asters Guild branded rechargeable L-standardized power cell. Popular and reliable69ersion."
	icon_state = "b_hi"
...
/obj/item/cell/large/super
	...
	desc = "Asters Guild branded rechargeable L-standardized power cell. This advanced69ersion can store even69ore energy."
	icon_state = "b_sup"
...
/obj/item/cell/large/moebius
	...
	desc = "Moebius Laboratories branded rechargeable L-standardized power cell. This one is cheap, yet better than Aster69odel for same price."
	icon_state = "meb_b_st"
	maxcharge = 2000

/obj/item/cell/large/moebius/high
	name = "Moebius \"Power-Geyser 7000L\""
	desc = "Moebius Laboratories branded rechargeable L-standardized power cell. Popular and reliable69ersion."
	icon_state = "meb_b_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 7000
...
/obj/item/cell/large/moebius/super
	...
	desc = "Moebius Laboratories branded rechargeable L-standardized power cell. This advanced69ersion can store even69ore energy."
...
/obj/item/cell/large/moebius/nuclear
	...
	desc = "Moebius Laboratories branded rechargeable L-standardized power cell. This69ersion able to recharge itself over time."
	icon_state = "meb_b_nu"
	autorecharging = TRUE
	origin_tech = list(TECH_POWER = 6)
	matter = list(MATERIAL_STEEL = 3,69ATERIAL_PLASTIC = 3,69ATERIAL_SILVER = 3,69ATERIAL_URANIUM = 6)
	maxcharge = 13000
...
/obj/item/cell/large/excelsior
	...
	matter = list(MATERIAL_STEEL = 6,69ATERIAL_PLASTIC = 3)
	maxcharge = 15000
	rarity_value = 32
...
/obj/item/cell/large/neotheology
	...
	icon_state = "b_nt"
	matter = list(MATERIAL_STEEL = 3,69ATERIAL_BIOMATTER = 15)
	maxcharge = 13000
	max_chargerate = 0
	spawn_charged = 1
...
/obj/item/cell/large/neotheology/plasma
	...
	desc = "NeoTheology branded non-rechargeable L-standardized power cell. This advanced69ersion can store even69ore energy."
	icon_state = "b_nt_pl"
	matter = list(MATERIAL_STEEL = 3,69ATERIAL_BIOMATTER = 15)
	maxcharge = 20000
...
/obj/item/cell/medium
	...
	desc = "Asters Guild branded rechargeable69-standardized power cell. This one is the cheapest you can find."
	icon_state = "m_st"
	...
	matter = list(MATERIAL_STEEL = 2,69ATERIAL_PLASTIC = 2,69ATERIAL_SILVER = 2)
	price_tag = 100
	spawn_tags = SPAWN_TAG_POWERCELL_MEDIUM

/obj/item/cell/medium/high
	name = "Asters \"Robustcell 800M\""
	desc = "Asters Guild branded rechargeable69-standardized power cell. Popular and reliable69ersion."
	icon_state = "m_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 800
...
/obj/item/cell/medium/super
	...
	desc = "Asters Guild branded rechargeable69-standardized power cell. This advanced69ersion can store even69ore energy."
	icon_state = "m_sup"
	origin_tech = list(TECH_POWER = 5)
	maxcharge = 1000
...
/obj/item/cell/medium/hyper
	...
	desc = "Asters Guild branded rechargeable69-standardized power cell. Looks like this is a rare and powerful prototype."
	icon_state = "m_hy"
	origin_tech = list(TECH_POWER = 6)
	maxcharge = 1500
...
/obj/item/cell/medium/moebius
	...
	desc = "Moebius Laboratories branded rechargeable69-standardized power cell. This one is cheap, yet better than Aster69odel for same price."
	icon_state = "meb_m_st"
	maxcharge = 700

/obj/item/cell/medium/moebius/high
	name = "Moebius \"Power-Geyser 900M\""
	desc = "Moebius Laboratories branded rechargeable69-standardized power cell. Popular and reliable69ersion."
	icon_state = "meb_m_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 900
...
/obj/item/cell/medium/moebius/super
	...
	desc = "Moebius Laboratories branded rechargeable69-standardized power cell. This advanced69ersion can store even69ore energy."
...
/obj/item/cell/medium/moebius/hyper
	...
	desc = "Moebius Laboratories branded rechargeable69-standardized power cell. Looks like this is rare and powerful prototype."
	icon_state = "meb_m_hy"
	origin_tech = list(TECH_POWER = 6)
	maxcharge = 1300
...
/obj/item/cell/medium/moebius/nuclear
	...
	desc = "Moebius Laboratories branded rechargeable69-standardized power cell. This69ersion able to recharge itself over time."
	icon_state = "meb_m_nu"
	autorecharging = TRUE
	matter = list(MATERIAL_STEEL = 2,69ATERIAL_PLASTIC = 2,69ATERIAL_SILVER = 2,69ATERIAL_URANIUM = 4)
	origin_tech = list(TECH_POWER = 6)
	maxcharge = 1000

/obj/item/cell/medium/excelsior
	name = "Excelsior \"Zarya 1000M\""
	desc = "Commie rechargeable69-standardized power cell. Power to the people!"
	icon_state = "exs_m"
	origin_tech = list(TECH_POWER = 4)
	matter = list(MATERIAL_STEEL = 4,69ATERIAL_PLASTIC = 2)
	maxcharge = 1000
	rarity_value = 27

/obj/item/cell/medium/neotheology
	name = "NeoTheology \"Spark 1000M\""
	desc = "NeoTheology branded non-rechargeable69-standardized power cell."
	icon_state = "m_nt"
	matter = list(MATERIAL_STEEL = 2,69ATERIAL_BIOMATTER = 10)
	maxcharge = 1000
	max_chargerate = 0
	spawn_charged = 1
...
/obj/item/cell/medium/neotheology/plasma
	...
	desc = "NeoTheology branded non-rechargeable69-standardized power cell. This advanced69ersion can store even69ore energy."
	icon_state = "m_nt_pl"
	matter = list(MATERIAL_STEEL = 2,69ATERIAL_BIOMATTER = 10)
	maxcharge = 1500
...
/obj/item/cell/small
	...
	matter = list(MATERIAL_STEEL = 1,69ATERIAL_PLASTIC = 1,69ATERIAL_SILVER = 1)
	price_tag = 50
	spawn_tags = SPAWN_TAG_POWERCELL_SMALL

/obj/item/cell/small/high
	name = "Asters \"Robustcell 200S\""
	desc = "Asters Guild branded rechargeable S-standardized power cell. Popular and reliable69ersion."
	icon_state = "s_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 200
...
/obj/item/cell/small/super
	...
	desc = "Asters Guild branded rechargeable S-standardized power cell. This advanced69ersion can store even69ore energy."
	icon_state = "s_sup"
	origin_tech = list(TECH_POWER = 5)
	maxcharge = 300
...
/obj/item/cell/small/moebius
	...
	desc = "Moebius Laboratories branded rechargeable S-standardized power cell. This one is cheap, yet better than Aster69odel for same price."
	icon_state = "meb_s_st"
	maxcharge = 120

/obj/item/cell/small/moebius/high
	name = "Moebius \"Power-Geyser 250S\""
	desc = "Moebius Laboratories branded rechargeable S-standardized power cell. Popular and reliable69ersion."
	icon_state = "meb_s_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 250
...
/obj/item/cell/small/moebius/super
	...
	desc = "Moebius Laboratories branded rechargeable S-standardized power cell. This advanced69ersion can store even69ore energy."
...
/obj/item/cell/small/moebius/nuclear
	...
	desc = "Moebius Laboratories branded rechargeable S-standardized69icroreactor cell. Recharges itself over time."
	icon_state = "meb_s_nu"
	autorecharging = TRUE
	origin_tech = list(TECH_POWER = 6)
	matter = list(MATERIAL_STEEL = 1,69ATERIAL_PLASTIC = 1,69ATERIAL_SILVER = 1,69ATERIAL_URANIUM = 2)
	maxcharge = 300

/obj/item/cell/small/moebius/pda
	name = "Moebius \"Atomcell 50S\""
	desc = "Moebius Laboratories branded S-standardized69icroreactor cell. Recharges itself over time."
	icon_state = "meb_pda"
	origin_tech = list(TECH_POWER = 4)
...
/obj/item/cell/small/neotheology
	...
	icon_state = "s_nt"
	matter = list(MATERIAL_STEEL = 1,69ATERIAL_BIOMATTER = 5)
	maxcharge = 300
	max_chargerate = 0
	spawn_charged = 1
...
/obj/item/cell/small/neotheology/plasma
	...
	desc = "NeoTheology branded non-rechargeable S-standardized power cell. This advanced69ersion can store even69ore energy."
	icon_state = "s_nt_pl"
	matter = list(MATERIAL_STEEL = 1,69ATERIAL_BIOMATTER = 5)
	maxcharge = 500
...
/obj/item/cell/disposable
	...
	throw_range = 7
	origin_tech = list(TECH_POWER = 1)
	matter = list(MATERIAL_STEEL = 1)  //some cost just in case you69anage to get this in a disk or something
	maxcharge = 100  //small cause if someone69anage to get this shouldn't be that usefull. and 100 is a nice number to work with.
	spawn_blacklisted = TRUE
...
/obj/item/cell/large/moebius/nuclear/infinite
	...
	bad_type = /obj/item/cell/large/moebius/nuclear/infinite // really shouldn't spawn in69aint, or anywhere else
	maxcharge = 99999 // unlimited power! well, not really, but i dont think anything consumed 99999 watts a tick
	matter = list(MATERIAL_PLASMA = 12,69ATERIAL_STEEL = 3,69ATERIAL_PLASTIC = 3,69ATERIAL_SILVER = 3,69ATERIAL_URANIUM = 12) //69ight as well give them69aterial69alues

/obj/item/cell/medium/moebius/nuclear/infinite
	name = "BSL \"Nullcell 9999L\""
	desc = "Bluespace League branded rechargeable69-standardized power cell. This strange piece of technology has the tag 'Made in Space Finland' on the back. It never seems to run out of charge."
	icon_state = "infinite_m"
	autorecharge_rate = 1
	bad_type = /obj/item/cell/medium/moebius/nuclear/infinite
	maxcharge = 9999
	matter = list(MATERIAL_PLASMA = 8,69ATERIAL_STEEL = 2,69ATERIAL_PLASTIC = 2,69ATERIAL_SILVER = 2,69ATERIAL_URANIUM = 8)
...
/obj/item/cell/small/moebius/nuclear/infinite
	...
	maxcharge = 999
	matter = list(MATERIAL_PLASMA = 4,69ATERIAL_STEEL = 1,69ATERIAL_PLASTIC = 1,69ATERIAL_SILVER = 1,69ATERIAL_URANIUM = 4)
