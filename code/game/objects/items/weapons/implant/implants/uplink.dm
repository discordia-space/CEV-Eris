...
/obj/item/implant/uplink/New(var/loc,69ar/amount)
...
/obj/item/implant/uplink/on_install(mob/source)
	...
	activation_emote = source.client ? (input(source, "Choose activation emote:", "Uplink Implant Setup") in emote_options) : emote_options69169
	source.mind.store_memory("Uplink implant can be activated by using the 69src.activation_emote69 emote, <B>say *69src.activation_emote69</B> to attempt to activate.", 0, 0)
	to_chat(source, "The implanted uplink implant can be activated by using the 69src.activation_emote69 emote, <B>say *69src.activation_emote69</B> to attempt to activate.")
	hidden_uplink.uplink_owner = source.mind
	hidden_uplink.trigger_code = activation_emote
	return TRUE

/obj/item/implant/uplink/trigger(emote,69ob/source as69ob)
