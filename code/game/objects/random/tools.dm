...
/obj/random/tool/item_to_spawn()
	return pickweight(list(/obj/random/rare = 1,
				...
				/obj/item/weapon/tool/screwdriver/electric = 5,
				/obj/item/weapon/tool/screwdriver/combi_driver = 3,
				/obj/item/weapon/tool/wirecutters = 10,
				/obj/item/weapon/tool/wirecutters/armature = 5,
				/obj/item/weapon/tool/weldingtool = 10,
				/obj/item/weapon/tool/weldingtool/advanced = 4,
				/obj/item/weapon/tool/omnitool = 3,
				/obj/item/weapon/tool/crowbar = 10,
				/obj/item/weapon/tool/crowbar/pneumatic = 5,
				/obj/item/weapon/tool/wrench = 10,
				/obj/item/weapon/tool/wrench/big_wrench = 5,
				/obj/item/weapon/tool/saw = 10,
				/obj/item/weapon/tool/saw/circular = 5,
				/obj/item/weapon/tool/saw/advanced_circular = 3,
				...
				/obj/item/weapon/tool/pickaxe/jackhammer = 2,
