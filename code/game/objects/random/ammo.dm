...
/obj/random/ammo/item_to_spawn()
	return pickweight(list(
				...
				/obj/item/weapon/storage/box/baton_rounds = 2,
				/obj/item/weapon/storage/box/emp_grenade_shells = 1,
				/obj/item/weapon/storage/box/frag_grenade_shells = 1,
				/obj/item/weapon/storage/box/blast_grenade_shells = 1,
