...
/obj/random/powercell/item_to_spawn()
	return pickweight(list(/obj/item/weapon/cell/large = 30,
				...
				/obj/item/weapon/cell/large/moebius/nuclear = 3,
				...
				/obj/item/weapon/cell/medium/moebius/nuclear = 3,
...
/obj/random/powercell/asters
	name = "random asters powercell"
	icon_state = "battery-orange"

/obj/random/powercell/asters/item_to_spawn()
	return pickweight(list(/obj/item/weapon/cell/large = 30,
				/obj/item/weapon/cell/large/high = 30,
				/obj/item/weapon/cell/large/super = 9,
				/obj/item/weapon/cell/large/hyper = 3,
...
/obj/random/powercell/moebius
	name = "random moebius powercell"
	icon_state = "battery-blue"

/obj/random/powercell/item_to_spawn()
	return pickweight(list(/obj/item/weapon/cell/large/moebius = 20,
				/obj/item/weapon/cell/large/moebius/high = 20,
				/obj/item/weapon/cell/large/moebius/super = 10,
				/obj/item/weapon/cell/large/moebius/hyper = 4,
				/obj/item/weapon/cell/large/moebius/nuclear = 3,
