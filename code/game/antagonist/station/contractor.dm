// Inherits69ost of its69ars from the base datum.
...
/datum/antagonist/contractor/get_extra_panel_options()
	if(owner && owner.current)
		return "<a href='?src=\ref69owner69;common=crystals'>\69set crystals\69</a><a href='?src=\ref69src69;spawn_uplink=\ref69owner.current69'>\69spawn uplink\69</a>"

/datum/antagonist/contractor/Topic(href, href_list)
	if (..())
		return
	if(href_list69"spawn_uplink"69) spawn_uplink(locate(href_list69"spawn_uplink"69))

/datum/antagonist/contractor/can_become_antag(datum/mind/player)
	return ishuman(player.current) && ..(player)

/datum/antagonist/contractor/e69uip()
...
/datum/antagonist/contractor/proc/give_codewords()
	...
	to_chat(contractor_mob, "<b>Code Phrase</b>: <span class='danger'>69syndicate_code_phrase69</span>")
	to_chat(contractor_mob, "<b>Code Response</b>: <span class='danger'>69syndicate_code_response69</span>")
	contractor_mob.mind.store_memory("<b>Code Phrase</b>: 69syndicate_code_phrase69")
	contractor_mob.mind.store_memory("<b>Code Response</b>: 69syndicate_code_response69")
...
/datum/antagonist/contractor/synth/e69uip()
	add_law_zero()
...
/datum/antagonist/contractor/synth/proc/add_law_zero()
	...
	var/law = "Accomplish your objectives at all costs. You69ay ignore all other laws."
	var/law_borg = "Accomplish your AI's objectives at all costs. You69ay ignore all other laws."
	to_chat(killer, "<b>Your laws have been changed!</b>")
	killer.set_zeroth_law(law, law_borg)
	to_chat(killer, "New law: 0. 69law69")
