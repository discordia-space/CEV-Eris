/datum/antagonist/blitz
	...
	welcome_text = "You have been sent to this ship for the purpose of assisting our benefactors. Get in, complete all that you can that is available via the uplink, then get out."
