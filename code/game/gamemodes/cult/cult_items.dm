...
/obj/item/weapon/melee/cultblade/attack(mob/living/M, mob/living/user, var/target_zone)
	...
	if(ishuman(user))
		...
		user << SPAN_DANGER("An unexplicable force rips through your [affecting.name], tearing the sword from your grasp!")
	else
		user << SPAN_DANGER("An unexplicable force rips through you, tearing the sword from your grasp!")
...
/obj/item/weapon/melee/cultblade/pickup(mob/living/user as mob)
	if(!iscultist(user))
		user << SPAN_WARNING("An overwhelming feeling of dread comes over you as you pick up the cultist's sword. It would be wise to be rid of this blade quickly.")
		user.make_dizzy(120)
