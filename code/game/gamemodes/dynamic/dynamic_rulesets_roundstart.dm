...
/datum/dynamic_ruleset/roundstart/vampire/execute()
	...
	for (var/i = 1 to num_vampires)
		...
		assigned += M
		candidates -= M
		var/datum/faction/vampire/fac = SSticker.mode.CreateFaction(/datum/faction/vampire, null, 1)
...
/datum/dynamic_ruleset/roundstart/wizard/execute()
	...
	if (M)
		...
		if (!federation)
			federation = SSticker.mode.CreateFaction(/datum/faction/wizard, null, 1)
...
/datum/dynamic_ruleset/roundstart/cwc/execute()
	...
	if (M)
		...
		var/datum/role/wizard/newWizard = new
		newWizard.AssignToRole(M.mind,1)
		var/datum/faction/wizard/civilwar/wpf/WPF = SSticker.mode.CreateFaction(/datum/faction/wizard/civilwar/wpf, null, 1)
		SSticker.mode.CreateFaction(/datum/faction/wizard/civilwar/pfw, null, 1)
...
/datum/dynamic_ruleset/roundstart/bloodcult/execute()
	...
	if (!cult)
		cult = SSticker.mode.CreateFaction(/datum/faction/bloodcult, null, 1)
...
/datum/dynamic_ruleset/roundstart/cult_legacy/execute()
	...
	if (!legacy)
		legacy = SSticker.mode.CreateFaction(/datum/faction/cult/narsie, null, 1)
...
/datum/dynamic_ruleset/roundstart/nuclear/execute()
	...
	if(!nuclear)
		nuclear = SSticker.mode.CreateFaction(/datum/faction/syndicate/nuke_op, null, 1)
...
/datum/dynamic_ruleset/roundstart/malf/execute()
	...
	if (!unction)
		unction = SSticker.mode.CreateFaction(/datum/faction/malf, null, 1)
...
/datum/dynamic_ruleset/roundstart/blob/execute()
	...
	if (!blob_fac)
		blob_fac = SSticker.mode.CreateFaction(/datum/faction/blob_conglomerate, null, 1)
