...
#define SPAWN_TAG_GUN_OS MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_GUN_OS)
...
#define SPAWN_CLOTHING_ONESTAR "onestar"
...
#define SPAWN_TAG_CLOTHING_ONESTAR MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_TAG_CLOTHING_ONESTAR)
