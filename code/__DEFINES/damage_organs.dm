...
// INTERNAL ORGANS
#define IORGAN_VITAL_HEALTH 8 // Heart
#define IORGAN_VITAL_BRUISE 4
#define IORGAN_VITAL_BREAK 6
#define IORGAN_STANDARD_HEALTH 6
#define IORGAN_STANDARD_BRUISE 3
#define IORGAN_STANDARD_BREAK 4
#define IORGAN_SMALL_HEALTH 4
#define IORGAN_SMALL_BRUISE 2
#define IORGAN_SMALL_BREAK 3
#define IORGAN_TINY_HEALTH 3
