...
#define CYBORG_TRAIT_AI_HACKED 0x16 // added when a cyborg is hacked by an AI, prevents hacking by other AI's
#define CYBORG_TRAIT_EMAGGED 0x32 // added when emagged
