...
#define INIT_ORDER_SKYBOX 90
#define INIT_ORDER_JOBS 89 // 65
#define INIT_ORDER_EVENTS 88 // 70
#define INIT_ORDER_TICKER 87 // 55
#define INIT_ORDER_SPAWN_DATA 86
#define INIT_ORDER_MAPPING 85 // 50
#define INIT_ORDER_LANGUAGE 84
#define INIT_ORDER_INVENTORY 83
#define INIT_ORDER_CHAR_SETUP 82
...
#define INIT_ORDER_CRAFT -3 // WE NEED THE LIST FOR ASSETS
...
#define INIT_ORDER_CHAT	-185 //Should be last to ensure chat remains smooth during init.
