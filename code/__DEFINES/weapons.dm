...
#define LETHAL				list(mode_name="kill", mode_desc="To defeat the Hobo, shoot it until it dies", projectile_type=/obj/item/projectile/beam, modifystate="energykill", item_modifystate="kill", fire_sound='sound/weapons/Laser.ogg', icon="kill")
