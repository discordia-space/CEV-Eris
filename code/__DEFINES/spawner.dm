...
#define SPAWN_TAG_TOOL_UPGRADE_RARE_OS SPAWN_TAG_TOOL_UPGRADE+";"+SPAWN_TOOL_UPGRADE_RARE+";item_tech_os"+";"+SPAWN_ONESTAR
...
#define SPAWN_TAG_PROSTHETIC_OS SPAWN_TAG_ITEM+";"+SPAWN_ORGAN+";organ_external;"+SPAWN_PROSTHETIC+";"+SPAWN_PROSTHETIC_OS+";item_tech_os"+";"+SPAWN_ONESTAR
...
#define SPAWN_TAG_GUN_ENERGY_XENOARCH SPAWN_TAG_ITEM+";"+SPAWN_GUN+";"+SPAWN_GUNS+";"+SPAWN_GUN_ENERGY+";"+SPAWN_XENOARCH
...
#define SPAWN_TAG_GUN_ENERGY SPAWN_TAG_ITEM+";"+SPAWN_GUN+";gun_energy"+";"+SPAWN_GUNS
#define SPAWN_TAG_GUN_ENERGY_CHAMALEON SPAWN_TAG_ITEM+";"+SPAWN_GUN+";gun_energy;contraband;chamaleon"+";"+SPAWN_GUNS
#define SPAWN_TAG_GUN_PROJECTILE SPAWN_TAG_ITEM+";"+SPAWN_GUN+";gun_projectile"+";"+SPAWN_GUNS
#define SPAWN_TAG_GUN_SHOTGUN SPAWN_TAG_ITEM+";"+SPAWN_GUN+";gun_projectile;shotgun"+";"+SPAWN_GUNS
#define SPAWN_TAG_GUN_SHOTGUN_ENERGY SPAWN_TAG_ITEM+";"+SPAWN_GUN+";gun_energy;shotgun"+";"+SPAWN_GUNS
#define SPAWN_TAG_GUN_ENERGY_BOTANICAL SPAWN_TAG_ITEM+";"+SPAWN_GUN+";gun_energy;botanical"+";"+SPAWN_GUNS
...
#define SPAWN_TAG_VOID_SUIT SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";suit;space_suit;void_suit"
#define SPAWN_TAG_MASK SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";mask"
#define SPAWN_TAG_MASK_CONTRABAND SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";mask;contraband;chamaleon"
#define SPAWN_TAG_HAZMATSUIT SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";hazmatsuit"
#define SPAWN_TAG_HOLSTER SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";holster"
#define SPAWN_TAG_SHOES SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";shoes"
#define SPAWN_TAG_SHOES_CHAMALEON SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";shoes;contraband;chamaleon"
#define SPAWN_TAG_GLOVES SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";gloves"
#define SPAWN_TAG_GLOVES_INSULATED SPAWN_TAG_GLOVES+";"+"item_utility"
#define SPAWN_TAG_GLOVES_CHAMALEON SPAWN_TAG_GLOVES+";"+"chamaleon;contraband"
#define SPAWN_TAG_CLOTHING_UNDER SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";under"
#define SPAWN_TAG_CLOTHING_UNDER_CHAMALEON SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";under;contraband;chamaleon"
#define SPAWN_TAG_CLOTHING_HEAD SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";head"
#define SPAWN_TAG_CLOTHING_HEAD_CHAMALEON SPAWN_TAG_CLOTHING_HEAD+";"+"chamaleon;contraband"
#define SPAWN_TAG_CLOTHING_HEAD_HELMET SPAWN_TAG_CLOTHING_HEAD+";"+"helmet"
#define SPAWN_TAG_CLOTHING_ARMOR SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";armor"
#define SPAWN_TAG_GLASSES SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";glasses"
#define SPAWN_TAG_GLASSES_CHAMALEON SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";glasses;contraband;chamaleon"
#define SPAWN_TAG_CLOTHING_SUIT_STORAGE SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";suit;suit_storage"
#define SPAWN_TAG_CLOTHING_SUIT_PONCHO SPAWN_TAG_ITEM+";"+SPAWN_CLOTHING+";suit;suit_poncho"
...
#define SPAWN_TAG_TOOLBOX SPAWN_TAG_STORAGE+";toolbox"
#define SPAWN_TAG_POUCH SPAWN_TAG_STORAGE+";pouch;clothing"
#define SPAWN_TAG_BELT SPAWN_TAG_STORAGE+";belt;clothing"
#define SPAWN_TAG_BELT_UTILITY SPAWN_TAG_STORAGE+";belt;clothing;item_utility"
#define SPAWN_TAG_BOX SPAWN_TAG_STORAGE+";box"
#define SPAWN_TAG_FIRSTAID SPAWN_TAG_STORAGE+";firstaid"
#define SPAWN_TAG_BACKPACK SPAWN_TAG_STORAGE+";backpack;clothing"
#define SPAWN_TAG_BACKPACK_CHAMALEON SPAWN_TAG_STORAGE+";backpack;clothing;contraband;chamaleon"
...
#define SPAWN_TAG_STOCK_PARTS_OS SPAWN_TAG_ITEM+";"+SPAWN_STOCK_PARTS+";stock_parts_os;item_tech_os"+";"+SPAWN_ONESTAR
...
//ITEMS - BEAKER
#define SPAWN_TAG_VIAL SPAWN_TAG_ITEM+";beaker;vial;science;"+SPAWN_MEDICAL
...
#define SPAWN_TAG_DESING_OS SPAWN_TAG_DESING+";desing_os;item_tech_os"+";"+SPAWN_ONESTAR
...
#define SPAWN_TAG_RIG_HAZMAT SPAWN_TAG_ITEM+";space_suit;rig_suit;"+SPAWN_SCIENCE
...
#define SPAWN_TAG_GRENADE_CLEANER SPAWN_TAG_GRENADE+";"+"grenade_cleaner;item_utility"
...
#define SPAWN_TAG_CLOSET_SECURE SPAWN_TAG_CLOSET+";closet_secure"//secure
#define SPAWN_TAG_TECHNICAL_CLOSET SPAWN_TAG_CLOSET+";closet_technical"
#define SPAWN_TAG_WARDROBE SPAWN_TAG_CLOSET+";wardrobe"
#define SPAWN_TAG_RANDOM_CLOSET SPAWN_TAG_CLOSET+";closet_random"
#define SPAWN_TAG_RANDOM_SECURE_CLOSET SPAWN_TAG_CLOSET+";closet_random;closet_secure"
#define SPAWN_TAG_CLOSET_LASERTAG SPAWN_TAG_CLOSET+";closet_lasertag"
#define SPAWN_TAG_CLOSET_BOMB SPAWN_TAG_CLOSET+";closet_bomb"
#define SPAWN_TAG_CLOSET_COFFIN SPAWN_TAG_CLOSET+";closet_coffin"
...
#define SPAWN_TAG_SALVAGEABLE_OS SPAWN_TAG_SALVAGEABLE+";structure_salvageable_os"+";"+SPAWN_ONESTAR
...
#define SPAWN_TAG_COMPUTERFRAME SPAWN_TAG_MACHINE_FRAME+";structure_computer_frame"
#define SPAWN_TAG_CONSTRUCTABLE_FRAME SPAWN_TAG_MACHINE_FRAME+";struture_constructable_frame"
...
#define SPAWN_TAG_ENCOUNTER_CRYOPOD SPAWN_TAG_ENCOUNTER_STRUCTURE+";"+"encounter_cryopod"
#define SPAWN_TAG_SATELITE SPAWN_TAG_ENCOUNTER_STRUCTURE+";"+"structure_satelite"
#define SPAWN_TAG_OMINOUS SPAWN_TAG_ENCOUNTER_STRUCTURE+";"+"structure_ominous"
#define SPAWN_TAG_STRANGEBEACON SPAWN_TAG_ENCOUNTER_STRUCTURE+";"+"strangebeacon"
...
#define SPAWN_TAG_MOB_OS_CUSTODIAN SPAWN_TAG_MOB_HOSTILE+";os_custodian"+";"+SPAWN_ONESTAR
#define SPAWN_TAG_MOB_HIVEMIND SPAWN_TAG_MOB_HOSTILE+";hivemind"
#define SPAWN_TAG_MOB_ROOMBA SPAWN_TAG_MOB_HOSTILE+";roomba"+";"+SPAWN_ONESTAR
...
#define SPAWN_TAG_ROACH_NANITE SPAWN_TAG_MOB_HOSTILE+";"+SPAWN_ROACH+";"+SPAWN_ROACH_NANITE
