...
// /mob/living signals
#define COMSIG_LIVING_STUN_EFFECT "stun effect act"             //mob/living/proc/stun_effect_act

// /mob/living/carbon signals
#define COMSIG_CARBON_ELECTROCTE "carbon electrocute act"       //mob/living/carbon/electrocute_act

// /mob/living/carbon/human signals
#define COMSIG_HUMAN_SAY "human_say"                            //from mob/living/carbon/human/say(): (message)
#define COMSIG_HUMAN_ROBOTIC_MODIFICATION "human robotic modification"
