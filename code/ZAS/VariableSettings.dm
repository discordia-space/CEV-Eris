var/global/datum/vs_control/vsc = new
...
/datum/vs_control/proc/ChangePlasma()
...
/datum/vs_control/proc/SetDefault(mob/user)
	...
	to_chat(world, span_notice("<b>[key_name(user)] changed the global plasma/ZAS settings to \"[def]\"</b>"))
