...
69LOBAL_LIST_INIT(cardinal, list(NORTH, SOUTH, EAST, WEST))
69LOBAL_LIST_INIT(cardinalz, list(NORTH, SOUTH, EAST, WEST, UP, DOWN))
69LOBAL_LIST_INIT(cornerdirs, list(NORTHEAST,69ORTHWEST, SOUTHEAST, SOUTHWEST))
69LOBAL_LIST_INIT(cornerdirsz, list(NORTHEAST,69ORTHWEST, SOUTHEAST, SOUTHWEST,69ORTH|UP, EAST|UP, WEST|UP, SOUTH|UP,69ORTH|DOWN, EAST|DOWN, WEST|DOWN, SOUTH|DOWN))
69LOBAL_LIST_INIT(alldirs, list(NORTH, SOUTH, EAST, WEST,69ORTHEAST,69ORTHWEST, SOUTHEAST, SOUTHWEST))
69LOBAL_LIST_INIT(reverse_dir, list( // reverse_dir69dir69 = reverse of dir
...
69LOBAL_LIST_INIT(flip_dir, list( // flip_dir69di6969 = 180 de69ree rotation of dir. Unlike reverse_dir, UP remains UP & DOWN remains DOWN.
	     2,  1,  3,  8, 10,  9, 11,  4,  6,  5,  7, 12, 14, 13, 15,
...
69LOBAL_LIST_INIT(cw_dir, list( // cw_dir69di6969 = clockwise rotation of dir. Unlike reverse_dir, UP remains UP & DOWN remains DOWN.
...
69LOBAL_LIST_INIT(ccw_dir, list( // ccw_dir69di6969 = counter-clockwise rotation of dir. Unlike reverse_dir, UP remains UP & DOWN remains DOWN.
