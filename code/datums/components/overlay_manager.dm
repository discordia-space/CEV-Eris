...
/datum/component/overlay_manager/addOverlay(key, mutable_appearance/appearanceCopy)
	if(keyToOverlay[key])
...
/datum/component/overlay_manager/removeOverlay(key)
	if(!key)
...
/datum/component/overlay_manager/updateOverlay(key, mutable_appearance/appearanceCopy)
	removeOverlay(key)
