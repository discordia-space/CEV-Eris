...
/datum/category_item/setup_option/background/origin/sich_prime
	name = "Sich Prime"
	desc = "A Ukrainian colony that was a major industrial center during the Corporation Wars, during which they made the fatal mistake of siding with The Company. \
...
/datum/category_item/setup_option/background/origin/new_rome
	name = "New Rome"
	desc = "One of the first colonies founded by American settlers, New Rome was rich with biosphere and natural resources and served as The Company�s headquarters when it was still an emerging power. As such, it holds the highest human population of any planet in the galaxy. \
			Although the War ended before it was sieged, New Rome suffered an economic crisis following the fall of The Company and never recovered. \
...
/datum/category_item/setup_option/background/origin/crozet
	...
	desc = "A lifeless, unforgiving ice world, rich with rare minerals, life on Crozet is only possible underground. \
			...
			This lasted until The Company invaded with the help of one of the Houses, and later, Crozet was left under NeoTheology control under the terms of a peace treaty. \
...
/datum/category_item/setup_option/background/origin/nss_forecaster
	name = "NSS \"Forecaster\""
	desc = "Designed to serve as large, FTL capable mining platform by the first days of The Company. \
			And it was used for that, until stars started coming back from Null Space. \
			In order to salvage those wonders first, The Company has sent this platform, reworked to serve as a local forward operating base, and renamed it to Central Command. \
