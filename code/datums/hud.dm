...
//		"painoverlay" = list("type" = /obj/screen/damageoverlay, "loc" = "WEST,SOUTH to EAST,NORTH", "icon" =  'icons/mob/screen1_full.dmi')
	...
	HUDfrippery = list(
		...
		list("loc" = "1,1", "icon_state" = "frame2", "dir" = NORTH),
		list("loc" = "1,2", "icon_state" = "frame2", "dir" = EAST),
		list("loc" = "1,3", "icon_state" = "frame2", "dir" = SOUTH),
		list("loc" = "1,1", "icon_state" = "frame1", "dir" = NORTHEAST),
		list("loc" = "1,2", "icon_state" = "frame1", "dir" = EAST),
		list("loc" = "1,3", "icon_state" = "frame1", "dir" = SOUTHEAST),
		list("loc" = "5,1", "icon_state" = "frame1", "dir" = NORTHWEST),
		list("loc" = "5,2", "icon_state" = "frame1", "dir" = WEST),
		list("loc" = "5,3", "icon_state" = "frame1", "dir" = SOUTHWEST),
		...
		list("loc" = "2,3", "icon_state" = "display", "dir" = WEST)
		)