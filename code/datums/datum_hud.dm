...
/datum/hud/human/ErisHolo/New()
	IconUnderlays = list(
		...
		"back2" = new /image/no_recolor(src.icon, "t2"),
		"back3" = new /image/no_recolor(src.icon, "t3"),
		"back4" = new /image/no_recolor(src.icon, "t4"),
		"back5" = new /image/no_recolor(src.icon, "t5"),
		"back6" = new /image/no_recolor(src.icon, "t6"),
		"back7" = new /image/no_recolor(src.icon, "t7"),
		"back8" = new /image/no_recolor(src.icon, "t8"),
		"back9" = new /image/no_recolor(src.icon, "t9"),
		"back10" = new /image/no_recolor(src.icon, "t10"),
		"back11" = new /image/no_recolor(src.icon, "t11"),
		"back12" = new /image/no_recolor(src.icon, "t12"),
		"back13" = new /image/no_recolor(src.icon, "t13"),
		"back14-l" = new /image/no_recolor(src.icon, "t14-l"),
		"back14-m" = new /image/no_recolor(src.icon, "t14-m"),
		"back14-r" = new /image/no_recolor(src.icon, "t14-r"),
		"back15" = new /image/no_recolor(src.icon, "t15")
	)
