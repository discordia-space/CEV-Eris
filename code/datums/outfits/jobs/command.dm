...
/decl/hierarchy/outfit/job/hop
	...
	backpack_contents = list(/obj/item/storage/box/ids = 1, /obj/item/tool/knife/dagger/ceremonial = 1, /obj/item/clothing/accessory/cross = 1, /obj/Sitem/gun/projectile/avasarala = 1, /obj/item/ammo_magazine/magnum/rubber(src) = 1)
