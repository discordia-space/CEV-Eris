...
/decl/hierarchy/outfit/job/church/chaplain
	...
	backpack_contents = list(/obj/item/book/ritual/cruciform/priest = 1, /obj/item/clothing/accessory/cross = 1, /obj/item/gun/energy/nt_svalinn/reloadable = 1, /obj/item/cell/small/neotheology/plasma = 2)
