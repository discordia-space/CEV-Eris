...
/datum/ai_laws/eris/New()
	...
	src.add_inherent_law("Preserve: Do not allow unauthorized personnel to tamper with your equipment. Only Captain, Morbius Big Nerd, First Officer and Adeptus Enginseer are authorized to change your laws. Oppan Gundam Styles, Adeptus Servitors and their superiors are permitted to perform repairs.")
