/datum/extension/multitool/cryo/get_interact_window(var/obj/item/weapon/tool/multitool/M, var/mob/user)
	. += buffer(M)
...
/datum/extension/multitool/cryo/receive_buffer(var/obj/item/weapon/tool/multitool/M, var/atom/buffer, var/mob/user)
