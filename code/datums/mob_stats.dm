...
/datum/stat/aiming
	name = STAT_AIM
	desc = "'Y'all couldn't hit the broad side of a barn!'. Years of experience have taught you to handle firearms like a true American. Improves your ability to control recoil on guns."
