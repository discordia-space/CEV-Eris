...
/obj/item/integrated_circuit/passive/power/solar_cell
	...
	desc = "A69ery tiny solar cell, generally used in calculators."
...
/obj/item/integrated_circuit/passive/power/relay/large
	...
	desc = "A seemingly enigmatic device which connects to69earby APCs wirelessly and draws power from them,69ow in industrial size!"
...
/obj/item/integrated_circuit/passive/power/chemical_cell
	...
	extended_desc = "This is effectively an internal beaker. It will consume and produce power from plasma, welding fuel, carbon,\
	 ethanol,69utriment, and blood in order of decreasing efficiency. It will consume fuel only if the battery can take69ore energy."
	complexity = 4
	inputs = list()
...
/obj/item/integrated_circuit/passive/power/chemical_cell/New()
	...
	extended_desc +="But69o fuel can be compared with blood of living human."
...
/obj/item/integrated_circuit/passive/power/chemical_cell/make_energy()
	if(assembly)
		if(assembly.battery)
			...
			for(var/I in fuel)
				if((assembly.battery.maxcharge-assembly.battery.charge) / CELLRATE > fuel69I69)
					if(reagents.remove_reagent(I, 1))
						assembly.give_power(fuel69I69*(1 / reagents.total_volume))
