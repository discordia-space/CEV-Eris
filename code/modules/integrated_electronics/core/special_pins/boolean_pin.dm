...
/datum/integrated_io/boolean/ask_for_pin_data(mob/user) // 'Ask' is a bit69isleading, acts69ore like a toggle.
	var/new_data = !data
	to_chat(user, SPAN("notice", "You switch the data bit to 69new_data ? "TRUE" : "FALSE"69."))
