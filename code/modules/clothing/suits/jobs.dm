...
/obj/item/clothing/suit/storage/ass_jacket
	...
	allowed = list(
		...
		/obj/item/weapon/gun/projectile, /obj/item/ammo_magazine, /obj/item/ammo_casing,/obj/item/weapon/melee/baton,
		/obj/item/weapon/handcuffs, /obj/item/weapon/storage/fancy/cigarettes, /obj/item/weapon/flame/lighter,
...
/obj/item/clothing/suit/storage/cargo_jacket
	...
	allowed = list(
		/obj/item/device/analyzer, /obj/item/device/flashlight, /obj/item/device/multitool, /obj/item/device/t_scanner,
		/obj/item/device/pipe_painter, /obj/item/device/radio, /obj/item/weapon/tool/wrench, /obj/item/weapon/crowbar,
		/obj/item/weapon/screwdriver, /obj/item/weapon/weldingtool, /obj/item/weapon/wirecutters,
		/obj/item/weapon/tank/emergency_oxygen, /obj/item/clothing/mask/gas, /obj/item/taperoll/engineering
	)
	armor = list(melee = 10, bullet = 0, laser = 0, energy = 0, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/suit/storage/qm_coat
	...
	desc = "An ideal choice for a smuggler.\
		This coat seems have good impact resistant, and made from resistant and expensive materials.."
	icon_state = "qm_coat"
	item_state = "qm_coat"
	blood_overlay_type = "coat"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|ARMS
	allowed = list(
		/obj/item/device/flashlight, /obj/item/weapon/gun/energy, /obj/item/weapon/gun/projectile,
		...
		/obj/item/device/analyzer, /obj/item/device/flashlight, /obj/item/device/multitool, /obj/item/device/radio,
		/obj/item/device/pipe_painter, /obj/item/device/t_scanner, /obj/item/weapon/crowbar,
		/obj/item/weapon/screwdriver, /obj/item/weapon/weldingtool, /obj/item/weapon/wirecutters,
		/obj/item/weapon/tool/wrench, /obj/item/weapon/tank/emergency_oxygen,
...
/obj/item/clothing/suit/storage/insp_trench
	...
	desc = "Brown and armored trenchcoat, designed and created by Ironhammer Security.\
		The coat is externally impact resistant - perfect for your next act of autodefenestration!"
...
/obj/item/clothing/suit/storage/hazardvest
	...
	allowed = list(
		...
		/obj/item/weapon/wirecutters, /obj/item/weapon/tool/wrench, /obj/item/weapon/tank/emergency_oxygen,
		/obj/item/clothing/mask/gas, /obj/item/taperoll/engineering
	)
...
/obj/item/clothing/suit/storage/robotech_jacket
	...
	blood_overlay_type = "coat"
	allowed = list (
		/obj/item/device/analyzer, /obj/item/device/flashlight, /obj/item/device/multitool, /obj/item/weapon/tool/wrench,
		/obj/item/device/pipe_painter, /obj/item/device/radio, /obj/item/device/t_scanner, /obj/item/clothing/mask/gas,
		/obj/item/weapon/screwdriver, /obj/item/weapon/weldingtool, /obj/item/weapon/wirecutters,
		/obj/item/weapon/crowbar, /obj/item/weapon/tank/emergency_oxygen,/obj/item/taperoll/engineering
	)
	body_parts_covered = UPPER_TORSO|ARMS