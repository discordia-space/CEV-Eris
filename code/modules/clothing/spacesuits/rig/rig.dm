...
/obj/item/rig
	...
	description_info = "A highly capable modular RIG system. Can hold modules which provide additional functionality. Also has a chance to completly deflect ballistic projectiles depending on the bullet protection"
	req_one_access = list()
	req_access = list()
