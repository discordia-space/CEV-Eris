...
/obj/item/rig_module/grenade_launcher
	...
	desc = "A shoulder-mounted69icro-explosive dispenser."
	selectable = 1
...
/obj/item/rig_module/grenade_launcher/accepts_item(var/obj/item/input_device,69ar/mob/living/user)
	...
	for(var/charge in charges)
		var/datum/rig_charge/charge_datum = charges69charge69
	...
	if(accepted_item.charges >= 5)
		to_chat(user, SPAN_DANGER("Another grenade of that type will not fit into the69odule."))
		return 0

	to_chat(user, "<font color='blue'><b>You slot \the 69input_device69 into the suit69odule.</b></font>")
...
/obj/item/rig_module/grenade_launcher/engage(atom/target)
	...
	H.visible_message(SPAN_DANGER("69H69 launches \a 69new_grenade69!"))
	new_grenade.activate(H)
	new_grenade.throw_at(target,fire_force,fire_distance)

/obj/item/rig_module/mounted
	name = "mounted laser cannon"
	desc = "A shoulder-mounted battery-powered laser cannon69ount."
	selectable = 1
	usable = 1
	module_cooldown = 1
...
/obj/item/rig_module/held/energy_blade/deactivate()
	...
	for(var/obj/item/melee/energy/blade/blade in69.contents)
		M.drop_from_inventory(blade)
		qdel(blade)

/obj/item/rig_module/held/shield
	name = "rig shield69odule"
...
/obj/item/rig_module/held/shield/activate()
	...
	if((src ==69.l_hand) || (src ==69.r_hand))
		return FALSE
	...
	M.visible_message(SPAN_WARNING("\The 69M69 deploys \his 69shield69!"))
...
/obj/item/rig_module/held/shield/deactivate()
	...
	for(var/obj/item/shield/hardsuit/shield in69.contents)
...
/obj/item/rig_module/fabricator
	...
	desc = "A self-contained69icrofactory system for hardsuit integration."
	selectable = 1
	usable = 1
	use_power_cost = 15
	icon_state = "enet"
	...
	interface_desc = "An integrated69icrofactory that produces poisoned throwing stars from thin air and electricity."
	rarity_value = 100
...
/obj/item/rig_module/fabricator/engage(atom/target)
	...
	if(target)
		...
		H.visible_message(SPAN_DANGER("69H69 launches \a 69firing69!"))
		...
		if(H.l_hand && H.r_hand)
			...
			to_chat(H, "<font color='blue'><b>You quickly fabricate \a 69new_weapon69.</b></font>")
