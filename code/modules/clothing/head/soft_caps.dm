...
/obj/item/clothing/head/soft/medical
	name = "Morbius medical cap"
	desc = "Cap worn by morbius medical personnel, usually outside spacecraft."
	icon_state = "medcap"
	item_state = "medcap"

///obj/item/clothing/head/soft/science
	//name = "morbius research cap"
	//desc = "Cap worn by morbius research personnel."
	//icon_state = "scicap"
	//item_state = "scicap"
