...
/obj/item/clothing/shoes/color/orange/proc/attach_cuffs(var/obj/item/handcuffs/cuffs,69ob/user as69ob)
...
/obj/item/clothing/shoes/color/orange/proc/remove_cuffs(mob/user as69ob)
	if (!src.chained) return
...
/obj/item/clothing/shoes/color/orange/attack_self(mob/user as69ob)
	..()
	remove_cuffs(user)

/obj/item/clothing/shoes/color/orange/attackby(H as obj,69ob/user as69ob)
	..()
