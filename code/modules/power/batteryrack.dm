...
/obj/machinery/power/smes/batteryrack/attackby(var/obj/item/W as obj, var/mob/user) //these can only be moved by being reconstructed, solves having to remake the powernet.
