...
//Types of items sold by the station
	assortiment = list(
		...
		"Energy Weaponry" = list(
			...
			/obj/item/weapon/gun/energy/plasma = custom_good_amount_range(list(2,-5)),
			/obj/item/weapon/gun/energy/plasma/destroyer = custom_good_amount_range(list(2,-5)),
			/obj/item/weapon/gun/energy/sniperrifle = custom_good_amount_range(list(1,-8)),
			/obj/item/weapon/gun/energy/crossbow/largecrossbow = custom_good_amount_range(list(1,-8)),
		),
		"Ballistics"  = list(
