/datum/trade_station/style
	...
	offer_types = list(
		...
		/obj/item/clothing/suit/armor/paramedic = offer_data("Morbius paramedic armor", 1000, 1),
		/obj/item/clothing/head/armor/faceshield/paramedic = offer_data("Morbius paramedic helmet", 1000, 1),
