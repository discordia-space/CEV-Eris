...
/obj/procedural/dungenerator/deepmaint/New()
	...
	spawn()
		...
		generate.name = name
		generate.setArea(locate(40, 40, z), locate(110, 110, z))
		generate.setWallType(list(/turf/simulated/wall, /turf/simulated/wall/iron))
		generate.setLightChance(2)
		generate.setFloorType(/turf/simulated/floor/tiled/dark/techfloor_grid)
		generate.setAllowedRooms(list(/obj/procedural/jp_DungeonRoom/preexist/square/submap/deepmaint/big))// TODO: Prevent the same room from spawning twice
		...
		generate.setArea(locate(10, 10, z), locate(150, 150, z))
