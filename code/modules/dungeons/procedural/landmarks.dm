...
/obj/procedural/dungenerator/New()
	...
	generate.setAllowedRooms(list(/obj/procedural/jp_DungeonRoom/preexist/square, /obj/procedural/jp_DungeonRoom/preexist/cross, /obj/procedural/jp_DungeonRoom/preexist/deadend, /obj/procedural/jp_DungeonRoom/preexist/circle))
...
/obj/procedural/dungenerator/deepmaint/New()
	...
	generate.setAllowedRooms(list(/obj/procedural/jp_DungeonRoom/preexist/square, /obj/procedural/jp_DungeonRoom/preexist/deadend, /obj/procedural/jp_DungeonRoom/preexist/circle))
	generate.setNumRooms(10)
	generate.setExtraPaths(5)
	generate.setMinPathLength(8)
	generate.setMaxPathLength(45)
