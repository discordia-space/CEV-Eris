	...
	switch(screenstate)
		if(0)
			...
			if(src.arcanecheckout)
				...
				SPAN_NOTICE("\The [user] stares at the blank screen for a few moments, \his expression frozen in fear. When \he finally awakens from it, \he looks a lot older."),
				SPAN_WARNING("Your sanity barely endures the seconds spent in the vault's browsing window. The only thing to remind you of this when you stop browsing is a dusty old tome sitting on the desk. You don't really remember printing it.")
				)
