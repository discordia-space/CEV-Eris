...
/proc/create_aura_image(newloc)
	...
	aura_image.appearance_flags = PIXEL_SCALE | NO_CLIENT_COLOR | RESET_COLOR | RESET_ALPHA | RESET_TRANSFORM
	aura_image.layer = TURF_LAYER + 0.5
	aura_image.alpha = 0
	aura_image.pixel_x = -64
	aura_image.pixel_y = -64
	aura_image.mouse_opacity = 0
	aura_image.appearance_flags = PIXEL_SCALE
...
// TODO: Implement armor mechanics
