/obj/item/clothing/accessory/bs_silk
	...
	var/silk_id = "" //using by snare controller to teleport user to controller's69ark

/obj/item/clothing/accessory/bs_silk/New()
	. = ..()
	matter = list(MATERIAL_STEEL = 8,69ATERIAL_GLASS = 5,69ATERIAL_SILVER = 10)
/*/obj/item/clothing/accessory/bs_silk/proc/toggle_lock()
	removable = !removable*/

/obj/item/clothing/accessory/bs_silk/attackby(obj/item/I,69ob/user)
	...
	/*if(istype(I, /obj/item/card/id))
		...
		if(locking_access in ID.GetAccess())
			...
			to_chat(user, SPAN_NOTICE("You toggle lock of 69src.name69. Now it is 69isLocked69"))
		else
...
/obj/item/clothing/accessory/bs_silk/examine()
	...
	to_chat(usr, "<br>On small display you can notice label that69ean: \"DEVICE ID: <b>69s_id69</b>\".")
	//to_chat(usr, "<br>It69removable ? " can be removed" : "'s locked by access: " + locking_access69.")