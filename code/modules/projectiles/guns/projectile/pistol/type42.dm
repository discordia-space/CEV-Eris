/obj/item/gun/projectile/type_42
	...
	desc = "An old Onestar pistol, designed with esoteric69echanisms. Uses .25 Caseless rounds."
	...
	matter = list(MATERIAL_PLASTEEL = 10,69ATERIAL_PLATINUM = 4,69ATERIAL_PLASTIC = 6)
	price_tag = 1800
	caliber = CAL_CLRIFLE
