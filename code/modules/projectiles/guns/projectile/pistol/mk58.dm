...
/obj/item/gun/projectile/mk58/army
	...
	desc = "The NT Mk58 is a cheap, ubiquitous sidearm, that was produced by a NanoTrasen subsidiary. this model appears to be the military model with nice rubber grips and a glow sight. Uses standard .35 and high capacity magazines."
