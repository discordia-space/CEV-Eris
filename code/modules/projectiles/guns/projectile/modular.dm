...
/obj/item/gun/projectile/modular // Parent type
	...
	force = 1 // it's a fragile piece of material, it isn't forceful by default
	...
	zoom_factors = list() //Default zoom factor
...
/obj/item/gun/projectile/modular/set_quality(var/new_quality = 0, doesReset = TRUE)
...
/obj/item/gun/projectile/modular/hand_spin(mob/living/carbon/caller)
