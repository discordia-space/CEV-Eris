/obj/item/weapon/gun/projectile/shotgun/pump/combat
	...
	desc = "Designed for close quarters combat, the Regulator is widely regarded as a weapon of choice for repelling boarders. \
			Some may say that it's too old, but it actually proved itself useful. Hits much harder due to full-rifled barrel, but recoil is also higher due to slightly shorter than usual barrel. Can hold up to 7 shells in tube magazine."
	icon_state = "cshotgun"
	item_state = "cshotgun"
