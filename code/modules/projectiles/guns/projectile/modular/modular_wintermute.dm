...
/obj/item/gun/projectile/automatic/modular/wintermute/finished // Total points: 6, as Wintermute has 2 from damage multiplier
	gun_parts = list(/obj/item/part/gun/modular/mechanism/autorifle/determined = 0, /obj/item/part/gun/modular/barrel/srifle = 0, /obj/item/part/gun/modular/grip/rubber = 0, /obj/item/part/gun/modular/stock = 0)
