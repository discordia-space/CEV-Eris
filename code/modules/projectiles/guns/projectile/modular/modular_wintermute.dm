/obj/item/gun/projectile/automatic/modular/wintermute
	name = "\"Wintermute\""
	desc = "IH. \
		 Pew pew."
	...
	list/required_parts = list(/obj/item/part/gun/modular/mechanism/autorifle/determined = 0, /obj/item/part/gun/modular/barrel = 0, /obj/item/part/gun/modular/grip = 0, /obj/item/part/gun/modular/stock = 0)
