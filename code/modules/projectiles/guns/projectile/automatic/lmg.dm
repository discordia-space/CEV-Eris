/obj/item/weapon/gun/projectile/automatic/lmg
	...
	rarity_value = 80
	gun_parts = list(/obj/item/part/gun = 1 ,/obj/item/stack/material/steel = 4)
...
/obj/item/weapon/gun/projectile/automatic/lmg/on_update_icon()
...
/obj/item/weapon/gun/projectile/automatic/lmg/pk/on_update_icon()
	icon_state = "[icon_base][cover_open ? "open" : "closed"][ammo_magazine ? round(ammo_magazine.stored_ammo.len, 25) : "-empty"]"
