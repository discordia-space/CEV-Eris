/obj/item/gun/projectile/automatic/luty
	...
	gun_parts = list(/obj/item/part/gun/frame/luty = 1, /obj/item/part/gun/modular/grip/wood = 1, /obj/item/part/gun/modular/mechanism/smg/steel = 1, /obj/item/part/gun/modular/barrel/pistol/steel = 1)
