...
/obj/item/weapon/gun/energy/plasma/cassad
	name = "FS PR \"Cassad\""
	desc = "\"Frozen Star\" brand energy assault rifle, capable of prolonged combat. When surrender is not an option. Melt mode excel at armor piercing due to extreme temperatures it cause."
