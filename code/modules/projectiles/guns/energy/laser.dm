...
/obj/item/weapon/gun/energy/captain
	...
	desc = "This weapon is old, yet still robust and reliable. It's marked with the old Company brand, a distant reminder of what this corporation was, before the Church took control of everything."
