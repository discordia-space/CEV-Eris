/obj/item/weapon/gun/energy/shrapnel
	...
	init_firemodes = list(
		list(mode_name="pellet", projectile_type=/obj/item/projectile/bullet/pellet/shotgun, charge_cost=50, icon="kill"),
		list(mode_name="stun", projectile_type=/obj/item/projectile/bullet/shotgun/beanbag, charge_cost=null, icon="stun"),
		list(mode_name="blast", projectile_type=/obj/item/projectile/bullet/shotgun, charge_cost=35, icon="destroy"),
	)
	var/consume_cell = FALSO
	price_tag = 2500
...
/obj/item/weapon/gun/energy/shrapnel/mounted
	...
	init_firemodes = list(
		list(mode_name="pellet", projectile_type=/obj/item/projectile/bullet/pellet/shotgun, charge_cost=150, icon="kill"),
		list(mode_name="stun", projectile_type=/obj/item/projectile/bullet/shotgun/beanbag, charge_cost=75, icon="stun"),
		list(mode_name="blast", projectile_type=/obj/item/projectile/bullet/shotgun, charge_cost=100, icon="destroy"),
