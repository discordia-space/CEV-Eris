...
/proc/make_scrap_ammo(mob/living/user, obj/source, extra_material_points = 0)
	...
	var/list/array = list(
		CAL_SRIFLE = list(
			...
			".20 pistol magazine (empty, 10 ammo, 5 points)" = list(5, /obj/item/ammo_magazine/cspistol/empty),
			".20 standard magazine (empty, 25 ammo, 5 points)" = list(5, /obj/item/ammo_magazine/srifle/empty),
			".20 extended magazine (empty, 35 ammo, 10 points)" = list(10, /obj/item/ammo_magazine/srifle/long/empty),
		...
		CAL_LRIFLE = list(
			...
			".30 drum magazine (empty, 45 ammo, 15 points)" = list(15, /obj/item/ammo_magazine/lrifle/drum/empty),
		...
		CAL_PISTOL = list(
			...
			".35 speedloader (6 ammo, 3 points)" = list(3, /obj/item/ammo_magazine/slpistol/scrap),
			".35 standard magazine (empty, 10 ammo, 5 points)" = list(5, /obj/item/ammo_magazine/pistol/empty),
			".35 extended magazine (empty, 16 ammo, 10 points)" = list(10, /obj/item/ammo_magazine/hpistol/empty),
			".35 SMG magazine (empty, 35 ammo, 10 points)" = list(10, /obj/item/ammo_magazine/smg/empty),
			".35 ammo box (70 ammo, 15 points)" = list(15, /obj/item/ammo_magazine/ammobox/pistol/scrap)),
		CAL_MAGNUM = list(
			".40 ammo pile (6 ammo, 3 points)" = list(3, /obj/item/ammo_casing/magnum/scrap/prespawned),
			...
			".40 SMG magazine (empty, 25 ammo, 9 points)" = list(9, /obj/item/ammo_magazine/msmg/empty),
