...
/obj/item/ammo_casing/grenade/smoke
	name = "FS SGR \"Conner\""
	desc = "A standard-issue Frozen Star smoke screen round, for hiding troop movements."
	icon_state = "grenade"
	projectile_type = /obj/item/projectile/bullet/grenade/handgrenade/smoke
	w_class = ITEM_SIZE_SMALL
	caliber = CAL_GRENADE
	is_caseless = TRUE
	maxamount = 1
...
/obj/item/ammo_casing/grenade/white_phosphorous
	name = "SA WPR \"Gornja\""
	desc = "A A modernized incendiary fresh out of serbia very flammable, for clearing out ship's and villages."
	icon_state = "warcrime"
