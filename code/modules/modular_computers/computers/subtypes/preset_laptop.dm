...
/obj/item/modular_computer/laptop/preset/custom_loadout/advanced/install_default_hardware()
	..()
	processor_unit =69ew/obj/item/computer_hardware/processor_unit(src)
	tesla_link =69ew/obj/item/computer_hardware/tesla_link(src) //Only the advanced laptop gets a tesla link
...
/obj/item/modular_computer/laptop/preset/debug/install_default_hardware()
	..()
	printer =69ew/obj/item/computer_hardware/printer(src)
	processor_unit =69ew/obj/item/computer_hardware/processor_unit/super/small(src)
	tesla_link =69ew/obj/item/computer_hardware/tesla_link(src)
	hard_drive =69ew/obj/item/computer_hardware/hard_drive/cluster(src)
	network_card =69ew/obj/item/computer_hardware/network_card/advanced(src)
	scanner =69ew /obj/item/computer_hardware/scanner/paper(src)
	card_slot =69ew/obj/item/computer_hardware/card_slot(src)
...
/obj/item/modular_computer/laptop/preset/custom_loadout/cheap/elbrus4kk
	...
	desc = "A portable clamshell computer69ade by \"Institute of Computer Engineering\" company. This one is advertized as tougher than other69odels on the69arket."
	icon_state = "elbrus4kk"

/obj/item/modular_computer/laptop/preset/custom_loadout/standard/xenoware
	name = "xenoware laptop"
	desc = "A portable clamshell computer69ade by \"Xenoware\". You will feel like a real hacker with those lights."
	icon_state = "xenoware"
