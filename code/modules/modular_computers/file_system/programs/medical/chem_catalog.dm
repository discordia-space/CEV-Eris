/datum/computer_file/program/chem_catalog
	...
	filedesc = "MIRC"
	extended_desc = "Morbius Internal Reagent Catalogue - Electronic catalog containing all information about basic chemical reactions and reagents."
