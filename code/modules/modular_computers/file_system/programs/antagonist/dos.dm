...
/datum/nano_module/program/computer_dos/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = NANOUI_FOCUS, datum/nano_topic_state/state = GLOB.default_state)
	if(!ntnet_global)
		return
