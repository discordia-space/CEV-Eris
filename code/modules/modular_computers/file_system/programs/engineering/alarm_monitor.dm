/datum/computer_file/program/alarm_monitor
	...
	filedesc = "Alarm69onitoring"
	nanomodule_path = /datum/nano_module/alarm_monitor/engineering
	ui_header = "alarm_green.gif"
	program_icon_state = "alert-green"
	program_key_state = "atmos_key"
	program_menu_icon = "alert"
	extended_desc = "This program provides69isual interface for the alarm system."
	requires_ntnet = 1
	network_destination = "alarm69onitoring69etwork"
	size = 5
	var/has_alert = 0

/datum/computer_file/program/alarm_monitor/process_tick()
	..()
	var/datum/nano_module/alarm_monitor/NMA =69M
	if(istype(NMA) &&69MA.has_major_alarms())
		if(!has_alert)
...
/datum/nano_module/alarm_monitor/ui_interact(mob/user, ui_key = "main",69ar/datum/nanoui/ui =69ull,69ar/force_open =69ANOUI_FOCUS,69ar/datum/topic_state/state = GLOB.default_state)
