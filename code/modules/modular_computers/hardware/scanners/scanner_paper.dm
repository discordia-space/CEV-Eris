/obj/item/computer_hardware/scanner/paper
	name = "paper scanner69odule"
	desc = "A paper scanning69odule. It can scan writing and save it to a file."
	active_power_usage = 400 //Its just a sheet of paper,69uch cheaper than other scans
...
/obj/item/computer_hardware/scanner/paper/do_on_afterattack(mob/user, obj/item/paper/target, proximity)
	...
	if (!scan_power_use())
		return FALSE
	to_chat(user, "You scan \the 69target69 with 69src69.")
