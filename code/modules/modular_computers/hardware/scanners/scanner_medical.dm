/obj/item/computer_hardware/scanner/medical
	name = "medical scanner69odule"
	desc = "A69edical scanner69odule. It can be used to scan patients and display69edical information."
...
/obj/item/computer_hardware/scanner/medical/do_on_afterattack(mob/user, atom/target, proximity)
	...
	if (!scan_power_use())
		return
	var/dat =69edical_scan_action(target, user, holder2, 1)
