...
About Reagents:
	...
	Procs:
		...
		affect_blood(var/mob/living/carbon/M, var/alien, var/effectMultiplier)
		...
		affect_ingest(var/mob/living/carbon/M, var/alien, var/effectMultiplier)
			Ditto, ingested. Defaults to affect_blood with halved dose.

		affect_touch(var/mob/living/carbon/M, var/alien, var/effectMultiplier)
			Ditto, touching.
