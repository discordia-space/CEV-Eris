...
/datum/reagent/medicine/bicaridine
	name = "Bicaridine"
	id = "bicaridine"
	description = "Bicaridine is an analgesic69edication and can be used to treat blunt trauma."
	taste_description = "bitterness"
	taste_mult = 3
	reagent_state = LI69UID
	color = "#BF0000"
...
/datum/reagent/medicine/meralyne
	name = "Meralyne"
	id = "meralyne"
	description = "Meralyne is the69ext step in brute trauma69edication. Works twice as good as bicaridine and enables the body to restore even the direst brute-damaged tissue."
	taste_description = "bitterness"
	taste_mult = 3
	reagent_state = LI69UID
	color = "#E6666C"
...
/datum/reagent/medicine/dermaline
	name = "Dermaline"
	id = "dermaline"
	description = "Dermaline is the69ext step in burn69edication. Works twice as good as kelotane and enables the body to restore even the direst heat-damaged tissue."
	taste_description = "bitterness"
	taste_mult = 1.5
	reagent_state = LI69UID
	color = "#FF8000"
...
/datum/reagent/medicine/dylovene/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.drowsyness =69ax(0,69.drowsyness - 0.6 * effect_multiplier)
...
/datum/reagent/medicine/cryoxadone
	name = "Cryoxadone"
	id = "cryoxadone"
	description = "A chemical69ixture with almost69agical healing powers. Its69ain limitation is that the targets body temperature69ust be under 170K for it to69etabolise correctly."
...
/datum/reagent/medicine/clonexadone
	name = "Clonexadone"
	id = "clonexadone"
	description = "A li69uid compound similar to that used in the cloning process. Can be used to 'finish' the cloning process when used in conjunction with a cryo tube."
...
/datum/reagent/medicine/paracetamol
	name = "Paracetamol"
	id = "paracetamol"
	description = "Most probably know this as Tylenol, but this chemical is a69ild, simple painkiller."
...
/datum/reagent/medicine/tramadol/overdose(mob/living/carbon/M, alien)
	...
	if(prob(3 - (2 *69.stats.getMult(STAT_TGH))))
		M.Stun(3)

/datum/reagent/medicine/oxycodone
	name = "Oxycodone"
	id = "oxycodone"
	description = "An effective and69ery addictive painkiller."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#800080"
...
/datum/reagent/medicine/synaptizine
	name = "Synaptizine"
	id = "synaptizine"
	description = "Synaptizine is used to treat69arious diseases."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#99CCFF"
	metabolism = REM * 0.05
...
/datum/reagent/medicine/synaptizine/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.drowsyness =69ax(M.drowsyness - 5, 0)
	M.AdjustParalysis(-1)
	M.AdjustStunned(-1)
	M.AdjustWeakened(-1)
	...
	M.adjustToxLoss(0.5 * effect_multiplier) // It used to be incredibly deadly due to an oversight.69ot anymore!
	M.add_chemical_effect(CE_PAINKILLER, 20)

/datum/reagent/medicine/alkysine
	name = "Alkysine"
	id = "alkysine"
	description = "Alkysine is a drug used to lessen the damage to69eurological tissue after a catastrophic injury. Can heal brain tissue."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#FFFF66"
	metabolism = REM * 0.25
...
/datum/reagent/medicine/imidazoline
	name = "Imidazoline"
	id = "imidazoline"
	description = "Helps69aturally regenerate and restore eye cells."
...
/datum/reagent/medicine/imidazoline/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.eye_blurry =69ax(M.eye_blurry - (5 * effect_multiplier), 0)
	M.eye_blind =69ax(M.eye_blind - (5 * effect_multiplier), 0)
	if(ishuman(M))
		var/mob/living/carbon/human/H =69
		var/obj/item/organ/internal/eyes/E = H.random_organ_by_process(OP_EYES)
		if(E && istype(E))
			if(E.damage > 0)
				E.damage =69ax(E.damage - (0.5 * effect_multiplier), 0)

/datum/reagent/medicine/peridaxon
	name = "Peridaxon"
	id = "peridaxon"
	description = "Used to encourage recovery of internal organs and69ervous systems.69edicate cautiously."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#561EC3"
	overdose = 10
...
/datum/reagent/medicine/peridaxon/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	if(ishuman(M))
		...
		for(var/obj/item/organ/I in H.internal_organs)
			if((I.damage > 0) && !BP_IS_ROBOTIC(I)) //Peridaxon heals only69on-robotic organs
				I.heal_damage(((0.2 + I.damage * 0.05) * effect_multiplier), FALSE)

/datum/reagent/medicine/ryetalyn
	name = "Ryetalyn"
	id = "ryetalyn"
	description = "Ryetalyn can cure all genetic abnomalities69ia a catalytic process."
...
/datum/reagent/medicine/ryetalyn/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	var/needs_update =69.mutations.len > 0

	M.mutations = list()
	M.disabilities = 0
	M.sdisabilities = 0

	//69ight69eed to update appearance for hulk etc.
	if(needs_update && ishuman(M))
		var/mob/living/carbon/human/H =69
		H.update_mutations()

/datum/reagent/medicine/negative_ling
	name = "Negative Paragenetic69arker"
	id = "negativeling"
	description = "A69arker compound that turns positive when put in contact with69orphogenic69utant blood."
	taste_description = "acid"
	reagent_state = SOLID
	color = "#022000"
...
/datum/reagent/medicine/positive_ling
	name = "Positive Paragenetic69arker"
	id = "positiveling"
	description = "This69arker compound has come in contact with69orphogenic69utant blood."
	taste_description = "acid"
	reagent_state = SOLID
	color = "#910000"
...
/datum/reagent/medicine/ethylredoxrazine/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	...
	M.confused = 0
	if(M.bloodstr)
		for(var/datum/reagent/R in69.bloodstr.reagent_list)
			if(istype(R, /datum/reagent/ethanol))
				R.dose =69ax(R.dose + effect_multiplier * 4, 0) // Increases the69etabolism rate of ethanol by 0.2 for each unit of ethylredoxrazine69etabolised

/datum/reagent/medicine/hyronalin
	name = "Hyronalin"
	id = "hyronalin"
	description = "Hyronalin is a69edicinal drug used to counter the effect of radiation poisoning."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#408000"
	metabolism = REM * 0.25
...
/datum/reagent/medicine/hyronalin/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.radiation =69ax(M.radiation - (3 * effect_multiplier), 0)

/datum/reagent/medicine/arithrazine
	name = "Arithrazine"
	id = "arithrazine"
	description = "Arithrazine is an unstable69edication used for the69ost extreme cases of radiation poisoning."
	reagent_state = LI69UID
	color = "#008000"
	metabolism = REM * 0.25
	overdose = REAGENTS_OVERDOSE
...
/datum/reagent/medicine/arithrazine/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.radiation =69ax(M.radiation - (7 + (M.radiation * 0.10)) * effect_multiplier, 0)
	M.adjustToxLoss(-(1 + (M.getToxLoss() * 0.05)) * effect_multiplier)
	if(prob(60))
...
/datum/reagent/medicine/sterilizine/affect_touch(mob/living/carbon/M, alien, effect_multiplier)
	M.germ_level -=69in(effect_multiplier * 2,69.germ_level)
	for(var/obj/item/I in69.contents)
		I.was_bloodied =69ull
	M.was_bloodied =69ull

/datum/reagent/medicine/sterilizine/touch_obj(var/obj/O)
	O.germ_level -=69in(volume*20, O.germ_level)
	O.was_bloodied =69ull

/datum/reagent/medicine/sterilizine/touch_turf(var/turf/T)
	T.germ_level -=69in(volume*20, T.germ_level)
...
/datum/reagent/medicine/leporazine/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	if(M.bodytemperature > 310)
		M.bodytemperature =69ax(310,69.bodytemperature - (40 * TEMPERATURE_DAMAGE_COEFFICIENT) * effect_multiplier)
	else if(M.bodytemperature < 311)
		M.bodytemperature =69in(310,69.bodytemperature + (40 * TEMPERATURE_DAMAGE_COEFFICIENT) * effect_multiplier)
...
/datum/reagent/medicine/methylphenidate/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	if(volume <= 0.1 && data != -1)
		...
		if(world.time > data + ANTIDEPRESSANT_MESSAGE_DELAY)
			data = world.time
			to_chat(M, SPAN_NOTICE("Your69ind feels focused and undivided."))

/datum/reagent/medicine/citalopram
	name = "Citalopram"
	id = "citalopram"
	description = "Stabilizes the69ind a little."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#FF80FF"
	metabolism = 0.01
...
/datum/reagent/medicine/citalopram/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	if(volume <= 0.1 && data != -1)
		data = -1
		to_chat(M, SPAN_WARNING("Your69ind feels a little less stable..."))
	else
		M.add_chemical_effect(CE_MIND, 1)
		if(world.time > data + ANTIDEPRESSANT_MESSAGE_DELAY)
			data = world.time
			to_chat(M, SPAN_NOTICE("Your69ind feels stable... a little stable."))

/datum/reagent/medicine/paroxetine
	name = "Paroxetine"
	id = "paroxetine"
	description = "Stabilizes the69ind greatly, but has a chance of adverse effects."
	reagent_state = LI69UID
	color = "#FF80BF"
	metabolism = 0.01
	data = 0
...
/datum/reagent/medicine/paroxetine/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	if(volume <= 0.1 && data != -1)
		data = -1
		to_chat(M, SPAN_WARNING("Your69ind feels69uch less stable..."))
	else
		M.add_chemical_effect(CE_MIND, 2)
		if(world.time > data + ANTIDEPRESSANT_MESSAGE_DELAY)
			data = world.time
			if(prob(90))
				to_chat(M, SPAN_NOTICE("Your69ind feels69uch69ore stable."))
			else
				to_chat(M, SPAN_WARNING("Your69ind breaks apart..."))
				M.hallucination(200, 100)

/datum/reagent/medicine/rezadone
	name = "Rezadone"
	id = "rezadone"
	description = "A powder with almost69agical properties, this substance can effectively treat genetic damage in humanoids, though excessive consumption has side effects."
	taste_description = "sickness"
	reagent_state = SOLID
	color = "#669900"
	overdose = REAGENTS_OVERDOSE
...
/datum/reagent/medicine/69uickclot
	name = "69uickclot"
	id = "69uickclot"
...
/datum/reagent/medicine/69uickclot/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	M.add_chemical_effect(CE_BLOODCLOT,69in(1,0.1 * effect_multiplier))	// adding 0.01 to be69ore than 0.1 in order to stop int bleeding from growing
	if(ishuman(M))
		var/mob/living/carbon/human/H =69
...
/datum/reagent/medicine/69uickclot/overdose(mob/living/carbon/M, alien)
	M.add_chemical_effect(CE_BLOODCLOT,69in(1, 0.20))

/datum/reagent/medicine/ossisine
	name = "Ossisine"
	id = "ossisine"
	description = "Puts the user in a great amount of pain and repairs broken bones one at a time.69edicate in critical conditions only."
...
/datum/reagent/medicine/noexcutite
	name = "Noexcutite"
	id = "noexcutite"
	description = "A thick, syrupy li69uid that has a lethargic effect. Used to cure cases of jitteriness."
...
/datum/reagent/medicine/kyphotorin
	name = "Kyphotorin"
	id = "kyphotorin"
	description = "Allows patient to grow back limbs. Extremely painful to user and69eeds constant69edical attention when applied."
	taste_description = "metal"
	reagent_state = LI69UID
	color = "#7d88e6"
	overdose = REAGENTS_OVERDOSE * 0.66
...
/datum/reagent/medicine/polystem
	name = "Polystem"
	id = "polystem"
	description = "Polystem boosts69atural body regeneration."
	taste_description = "bitterness"
	taste_mult = 3
	reagent_state = LI69UID
	color = "#ded890"
...
/datum/reagent/medicine/polystem/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	...
	M.add_chemical_effect(CE_BLOODCLOT,69in(1,0.1 * effect_multiplier))

/datum/reagent/medicine/polystem/overdose(mob/living/carbon/M, alien)
	M.add_chemical_effect(CE_BLOODCLOT,69in(1,0.1))

/datum/reagent/medicine/detox
	name = "Detox"
	id = "detox"
	description = "Boosts69eural regeneration, allowing69eural system to tolerate69ore chemicals without permament damage."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#229e08"
	overdose = REAGENTS_OVERDOSE
...
/datum/reagent/medicine/addictol/affect_blood(mob/living/carbon/M, alien, effect_multiplier)
	...
	if(istype(C) && C.metabolism_effects.addiction_list.len)
		if(prob(5 * effect_multiplier + dose))
			...
			to_chat(C, SPAN_NOTICE("You dont crave for 69R.name69 anymore."))
...
/datum/reagent/medicine/haloperidol
	name = "Haloperidol"
	id = "haloperidol"
	description = "Purges chems from bloodstream, lowers69SA and sedates patient. An overdose of haloperidol can be fatal."
	taste_description = "bitterness"
	reagent_state = LI69UID
	color = "#ba1f04"
	overdose = REAGENTS_OVERDOSE/2
...
/datum/reagent/medicine/vomitol
	name = "Vomitol"
	id = "vomitol"
	description = "Forces patient to69omit - results in total cleaning of his stomach. Has extremely unpleasant taste and seems to collect on food in69ushroom rich enviroments."
