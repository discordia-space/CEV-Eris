...
/obj/machinery/chem_master/attackby(var/obj/item/B as obj, var/mob/user)
...
/obj/machinery/chem_master/attack_hand(mob/user)
	...
	if(!beaker)
		...
		if(reagents.total_volume)
			...
			dat += "Empty<BR>"
		if(!condi)
			dat += "<HR><BR><a href='byond://?src=\ref[src];createpill=1'>Create pill ([max_pill_count] units max)</A><a href='byond://\"?src=\ref[src]&change_pill=1\"'><img src=\"pill[pillsprite].png\" /></a><BR>"
			dat += "<a href='byond://?src=\ref[src];createpill_multiple=1'>Create multiple pills</A><BR>"
			dat += "<a href='byond://?src=\ref[src];createbottle=1'>Create bottle (60 units max)<a href='byond://\"?src=\ref[src]&change_bottle=1\"'><img src=\"[bottlesprite].png\" /></A>"
		else
