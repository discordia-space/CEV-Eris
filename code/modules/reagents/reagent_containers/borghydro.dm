...
/obj/item/weapon/reagent_containers/borghypo/medical
	reagent_ids = list("bicaridine", "kelotane", "anti_toxin", "dexalin", "inaprovaline", "paracetamol", "spaceacillin", "stoxin")

/obj/item/weapon/reagent_containers/borghypo/rescue
	reagent_ids = list("tricordrazine", "inaprovaline", "paracetamol")
