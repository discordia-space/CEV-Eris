/datum/hud/exosuits
	...
	icon = MECHA_HUD_ICON
	HUDneed = list(
		"mech_damage_zone"			=	list("type" =	/obj/screen/zone_sel,							"loc" = "15,1"),
		...
		"mech_hud_health"			=	list("type" =	/obj/screen/movable/exosuit/health,				"loc" = ""),
		"mech_hud_power"			=	list("type" =	/obj/screen/movable/exosuit/power,				"loc" = ""),
		"mech_hud_open"				=	list("type" =	/obj/screen/movable/exosuit/toggle/hatch_open,	"loc" = ""),
