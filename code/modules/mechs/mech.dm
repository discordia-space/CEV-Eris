...
/mob/living/exosuit/examine(mob/user, extra_description = "")
	...
	extra_description += SPAN_NOTICE("A multitool can be used on HELP intent to remove module from hardpoints , or on any other intent to start unlocking the mech through hacking."))
