...
/client/proc/browse_queue_flush(timeout = 50)
	...
	src << browse(HTML_SKELETON({"<script>window.location.href='byond://?asset_cache_confirm_arrival=[job]"</script>"}), "window=asset_cache_browser&file=asset_cache_send_verify.htm")
