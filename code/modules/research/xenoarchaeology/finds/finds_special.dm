...
/obj/item/clothing/mask/gas/poltergeist/hear_talk(mob/M as mob, text, verb, datum/language/speaking, speechVolume)
	..()
...
/obj/item/weapon/vampiric/hear_talk(mob/M as mob, text, verb, datum/language/speaking, speechVolume)
	..()
