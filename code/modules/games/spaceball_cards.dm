/obj/item/pack/spaceball
	...
	desc = "Officially licensed to take your69oney."
...
/obj/item/pack/spaceball/Initialize(mapload, ...)
	...
	for(i=0;i<5;i++)
		P = new()
		if(prob(1))
			P.name = "Spaceball Jones, 69year69 Brickburn Galaxy Trekers"
			...
			P.name = "69L.get_random_name(pick(MALE,FEMALE))69, 69year - rand(0,50)69 69team69"
