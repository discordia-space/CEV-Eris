...
var/global/list/SKILL_PRE = list("Engineer" = SKILL_ENGINEER, "Roboticist" = SKILL_ORGAN_ROBOTICIST, "Ironhammer Operative" = SKILL_SECURITY_OFFICER, "Chemist" = SKILL_CHEMIST)
