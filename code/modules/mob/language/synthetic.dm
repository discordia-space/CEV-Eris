...
/datum/language/binary/broadcast(var/mob/living/speaker,var/message,var/speaker_mask)
	...
	for(var/mob/living/S in GLOB.living_mob_list)
		...
		if(drone_only && !isdrone(S))
			...
			message_start = "<i><span class='game say'>[name], <a href='byond://byond://?src=\ref[S];track2=\ref[S];track=\ref[speaker];trackname=[html_encode(speaker.name)]'><span class='name'>[speaker.name]</span></a></span></i>"
