...
var/list/rank_prefix = list(\
	...
	"Captain" = "Captain",\
	"Neotheology Preacher" = "Presbyter",\
	"NeoTheology Acolyte" = "Protodeacon",\
	"NeoTheology Inquisitor" = "Heiromonk",\
	"NeoTheology Agrolyte" = "Liturge",\
	"NeoTheology Custodian" = "Archdeacon",\
