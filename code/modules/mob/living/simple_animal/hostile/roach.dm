/mob/living/simple_animal/hostile/roach
	name = "Kampfer Roach"
	desc = "A monstrous cockroach is the size of a grown dog. These huge mutants can be everywhere where humans are, on ships, planets and stations."
	icon_state = "roach"
	speak_chance = 0
	turns_per_move = 3
...
/mob/living/simple_animal/hostile/roach/tank
	name = "Panzer Roach"
	desc = "A monstrous cockroach is the size of a huge dog. This one looks more robust than others."
	icon_state = "panzer"
	meat_amount = 4
	turns_per_move = 2
	maxHealth = 30
...
/mob/living/simple_animal/hostile/roach/hunter
	name = "Jager Roach"
	desc = "A monstrous cockroach is the size of a grown dog. This one have a bigger claws."
	icon_state = "jager"
	meat_amount = 3
	turns_per_move = 2
	maxHealth = 15
...
/mob/living/simple_animal/hostile/roach/support
	name = "Seuche Roach"
	desc = "A monstrous cockroach is the size of a grown dog. This one smells like hell and secretes strange vapors."
	icon_state = "seuche"
	meat_amount = 3
	turns_per_move = 4
	maxHealth = 20
