...
/mob/living/captive_brain/say(var/message)
	...
	if(istype(src.loc,/mob/living/simple_animal/borer))
		...
		to_chat(src, "You whisper silently, \"69message69\"")
		to_chat(B.host, "The captive69ind of 69src69 whispers, \"69message69\"")

		for (var/mob/M in GLOB.player_list)
			if (isnewplayer(M))
				continue
			else if(M.stat == DEAD &&69.get_preference_value(/datum/client_preference/ghost_ears) == GLOB.PREF_ALL_SPEECH)
				to_chat(M, "The captive69ind of 69src69 whispers, \"69message69\"")
	...
	if(istype(controler))
		...
		to_chat(src, "You whisper silently, \"69message69\"")
		to_chat(controler.wearer, "The captive69ind of 69src69 whispers, \"69message69\"")
...
/mob/living/captive_brain/process_resist()
	//Resisting control by an alien69ind.
	if(istype(src.loc,/mob/living/simple_animal/borer))
		var/mob/living/simple_animal/borer/B = src.loc
		...
		to_chat(B.host, SPAN_DANGER("You feel the captive69ind of 69src69 begin to resist your control."))
		...
		spawn(rand(200,250)+B.host.brainloss)
			...
			to_chat(B.host, SPAN_DANGER("You feel control of the host brain ripped from your grasp, and retract your probosci before the wild69eural impulses can damage you."))
			B.detatch()
