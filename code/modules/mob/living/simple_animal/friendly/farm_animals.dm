...
/mob/living/simple_animal/hostile/retaliate/goat/attackby(var/obj/item/O as obj, var/mob/user)
...
/mob/living/simple_animal/cow/attackby(var/obj/item/O as obj, var/mob/user)
	var/obj/item/reagent_containers/G = O
	if(stat == CONSCIOUS && istype(G) && G.is_refillable())
		user.visible_message(SPAN_NOTICE("[user] milks [src] using \the [O]."))
		var/transfered = udder.trans_id_to(G, "milk", rand(5,10))
...
/mob/living/simple_animal/chicken/attackby(var/obj/item/O as obj, var/mob/user)
