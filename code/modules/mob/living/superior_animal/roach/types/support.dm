...
/superior_animal/roach/support/New()
	..()
	create_reagents(100)

/superior_animal/roach/support/proc/gas_attack()
...
/superior_animal/roach/support/Life()
	..()
	if(stat != CONSCIOUS)
		return
...
/superior_animal/roach/support/findTarget()
	. = ..()
	if(. && gas_attack())
