...
/mob/proc/put_in_any_hand_if_possible(obj/item/W, del_on_fail = FALSE, disable_warning = TRUE, redraw_mob = TRUE)
...
/mob/proc/equip_to_slot_if_possible(obj/item/W, slot, del_on_fail = FALSE, disable_warning = FALSE, redraw_mob = TRUE)
...
/mob/proc/equip_to_appropriate_slot(obj/item/W)
	...
	for(var/slot in slot_equipment_priority)
		if(equip_to_slot_if_possible(W, slot, del_on_fail = FALSE, disable_warning = TRUE, redraw_mob = TRUE))
			return TRUE
...
/mob/proc/drop_from_inventory(obj/item/W, atom/Target = null, drop_flag = null)
	if(W)
		if(!Target)
			Target = loc
...
/mob/proc/unEquip(obj/item/I, atom/Target = null, force = FALSE) //Force overrides NODROP for things like wizarditis and admin undress.
	if(!canUnEquip(I))
		return
...
/mob/proc/can_pickup(obj/item/I, feedback = TRUE)
...
//for info see /mob/proc/equip_to_slot_if_possible
/////
/mob/proc/play_short()
