...
/datum/nano_topic_state/remote/New(remoter, remote_target, datum/nano_topic_state/remoter_state = GLOB.default_state)
	src.remoter = remoter
...
/datum/nano_topic_state/remote/can_use_topic(datum/src_object, mob/user)
