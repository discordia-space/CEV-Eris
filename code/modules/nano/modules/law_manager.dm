...
/datum/nano_module/law_manager/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui, force_open = NANOUI_FOCUS, datum/nano_topic_state/state = GLOB.default_state)
	var/data[0]
	owner.lawsync()
