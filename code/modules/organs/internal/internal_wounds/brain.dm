...
// Blunt
/datum/internal_wound/organic/brain_blunt
...
/datum/internal_wound/organic/brain_sharp/punctured
	name = "punctured brain tissue"

/datum/internal_wound/organic/brain_sharp/lobe
	name = "gored brain lobe"
	treatments_tool = list(QUALITY_CLAMPING = FAILCHANCE_HARD)

/datum/internal_wound/organic/brain_sharp/penetrating
	...
	scar = list(/datum/internal_wound/organic/penetrating2) // stage 2

/datum/internal_wound/organic/penetrating2	 // stage 2
...
// /datum/internal_wound/organic/brain_sharp/gore
//	name = "gored frontal lobe" //-- is that the bite of 87????????????????????????

// Edge
/datum/internal_wound/organic/brain_edge
	treatments_item = list(/obj/item/stack/medical/advanced/bruise_pack = 2)
	treatments_tool = list(QUALITY_CAUTERIZING = FAILCHANCE_HARD)
	treatments_chem = list(CE_BRAINHEAL = 1)
	severity = 0
...
/datum/internal_wound/organic/brain_edge/laceration
	name = "brain laceration"

/datum/internal_wound/organic/brain_edge/slice
	name = "sliced brain tissue"

/datum/internal_wound/organic/brain_edge/rip
	name = "ripped brain fibers"
	treatments_item = list(/obj/item/stack/medical/advanced/bruise_pack = 4)
	treatments_tool = list(QUALITY_CLAMPING = FAILCHANCE_HARD)
	scar = list(/datum/internal_wound/organic/rip2)

/datum/internal_wound/organic/rip2
...
// Burn
/datum/internal_wound/organic/brain_burn
...
/datum/internal_wound/organic/brain_burn/brain_matter
	name = "burnt brain matter"
/datum/internal_wound/organic/brain_burn/cooked
	name = "well-cooked brain"
	treatments_item = list(/obj/item/stack/medical/advanced/ointment = 4)
/datum/internal_wound/organic/brain_burn/incinerate
...
/datum/internal_wound/robotic/brain_blunt/malfunction
	name = "damaged neural processor"
	treatments_tool = list(QUALITY_CAUTERIZING = FAILCHANCE_HARD)
/datum/internal_wound/robotic/brain_blunt/voxel
	name = "voxel matrix deformation"
	treatments_tool = list(QUALITY_LASER_CUTTING = FAILCHANCE_HARD)
/datum/internal_wound/robotic/brain_blunt/loose
...
// Sharp
/datum/internal_wound/robotic/brain_sharp
	treatments_item = list(/obj/item/stack/nanopaste = 1)
	treatments_tool = list(QUALITY_CAUTERIZING = FAILCHANCE_HARD)
...
/datum/internal_wound/robotic/brain_sharp/puncture
	name = "punctured structure"

/datum/internal_wound/robotic/brain_sharp/shell
	name = "wrecked brain shell"
	treatments_tool = list(QUALITY_WELDING = FAILCHANCE_HARD)

/datum/internal_wound/robotic/brain_sharp/nand1
	name = "broken NAND circuit loop"
	treatments_tool = list(QUALITY_CAUTERIZING = FAILCHANCE_HARD)
	scar = /datum/internal_wound/robotic/nand2

/datum/internal_wound/robotic/nand2
	name = "broken NAND circuit loop"
	treatments_tool = list(QUALITY_PULSING = FAILCHANCE_HARD)

// Edge
/datum/internal_wound/robotic/brain_edge
...
/datum/internal_wound/robotic/brain_edge/trimmed
	name = "trimmed down VRAM"
	treatments_tool = list(QUALITY_WELDING = FAILCHANCE_HARD)

/datum/internal_wound/robotic/brain_edge/disheveled
	name = "cut fiber-optic cord"
	treatments_tool = list(QUALITY_BOLT_TURNING = FAILCHANCE_HARD)

/datum/internal_wound/robotic/brain_edge/shred1
	name = "scrapped bracing"
	treatments_tool = list(QUALITY_PRYING = FAILCHANCE_HARD)
	scar = /datum/internal_wound/robotic/shred2

/datum/internal_wound/robotic/shred2
	name = "scrapped bracing"
	treatments_tool = list(QUALITY_WELDING = FAILCHANCE_HARD)
...
// EMP/burn wounds
/datum/internal_wound/robotic/brain_emp_burn
	treatments_item = list(/obj/item/stack/cable_coil = 5, /obj/item/stack/nanopaste = 1)
	treatments_tool = list(QUALITY_CAUTERIZING = FAILCHANCE_HARD)
...
/datum/internal_wound/robotic/brain_emp_burn/elec_malfunction
	name = "electrical malfunction"
	treatments_tool = list(QUALITY_PULSING = FAILCHANCE_HARD)

/datum/internal_wound/robotic/brain_emp_burn/cognitive_disorder
