...
/datum/stash/valueable
	...
	contents_list_base = list(/obj/random/credits/c5000 = 1)
	 contents_list_random = list(/obj/item/stack/material/diamond/random = 15,
	 /obj/item/stack/telecrystal/random = 10
	 /obj/item/stack/material/platinum/random = 15,
	 /obj/item/stack/material/gold/random = 20,
	 /obj/item/stack/material/silver/random = 30
