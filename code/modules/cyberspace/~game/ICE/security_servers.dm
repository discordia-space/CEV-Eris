...
/obj/machinery/cyber_security_server/proc/PreventAPCHack(mob/observer/cyberspace_eye/user, datum/CyberSpaceAvatar/user_avatar, params)
...
/datum/CyberSpaceAvatar/interactable/cybersecurity_server/HackingTry(mob/observer/cyberspace_eye/user, datum/CyberSpaceAvatar/user_avatar, params)
...
/datum/CyberSpaceAvatar/interactable/cybersecurity_server/Hacked(mob/observer/cyberspace_eye/user, datum/CyberSpaceAvatar/user_avatar, params)
	. = ..()
	if(Owner)
