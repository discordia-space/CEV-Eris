...
ADMIN_VERB_ADD(/client/proc/cmd_admin_subtle_message, R_ADMIN)
...
ADMIN_VERB_ADD(/client/proc/toggle_antagHUD_use, R_ADMIN)
...
ADMIN_VERB_ADD(/client/proc/toggle_antagHUD_restrictions, R_ADMIN)
...
ADMIN_VERB_ADD(/client/proc/cmd_admin_rejuvenate, R_ADMIN)
