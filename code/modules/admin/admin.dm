...
/datum/admins/proc/view_log_panel(mob/M)
	...
	usr << browse(HTML_SKELETON(body), "window=\ref[M]logs;size=500x500")
...
/datum/admins/proc/show_player_panel(mob/M in SSmobs.mob_list | SShumans.mob_list)
	...
	if(M.client)
		body += " played by <b><a href='byond://http://byond.com/members/[M.client.ckey]'>[M.client]</b></a> "
	...
	usr << browse(HTML_SKELETON(body), "window=adminplayeropts;size=550x515")
