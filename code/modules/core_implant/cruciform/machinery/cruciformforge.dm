...
/obj/machinery/neotheology/cruciformforge
	...
	desc = "This unique piece of technology can be fed biomatter, plasteel, and gold in order to print more cruciforms. Only a select few NanoTrasen architects know how to create these machines. "
