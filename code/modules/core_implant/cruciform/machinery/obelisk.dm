...
/obj/machinery/power/nt_obelisk
	...
	description_info = "Obelisks help provide observation for the Eye, alongside granting faster sanity regeneration to NT faithful. In addition, when \"active\", they will repel weeds and damage hostile fauna such as roaches within range."
