...
/datum/ritual/cruciform/priest/construction/perform(mob/living/carbon/human/user, obj/item/weapon/implant/core_implant/C, list/targets)
	...
	for(var/item_type in blueprint.materials)
		...
		qdel(thing)
    user.visible_message(SPAN_NOTICE("You hear a soft humming sound as [user] finishes his ritual."), SPAN_NOTICE("You take a deep breath as items stopped forming your construction."))
