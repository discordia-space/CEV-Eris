...
/obj/item/implant/core_implant/cruciform/activate()
	...
	disciples |= wearer
	spawn()
		alert(wearer, SPAN_NOTICE("You feel immortal, you are now a follower of Neotheology. Your clan-affinity now resides with NT at the top, with your departament coming second."), "New self", "Ok")
