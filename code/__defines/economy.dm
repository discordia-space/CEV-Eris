...
#define WAGE_LABOUR_HAZARD	800	//Hazard pay. For miners and IHOperatives
#define WAGE_PROFESSIONAL	1200	//The wage for educated professionals. Doctors, scientists, etc
#define WAGE_COMMAND		1600	//Wage paid to command staff, generally regardless of department
