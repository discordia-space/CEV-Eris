							...
							{!!explain_attack && (
								<Stack.Item>
									<Section fill title="Demonic Powers">
										<Stack vertical>
											<Stack.Item>
												<span style={jauntstyle}>
													Blood Jaunt:
												</span>{' '}
												You can dive in and out of blood
												to travel anywhere you need to
												be. You will gain a speed boost
												upon leaving the jaunt for
												surprise attacks. You can drag
												victims you have disabled
												through the blood, consuming
												them and restoring health.
											</Stack.Item>
											<Stack.Divider />
											<Stack.Item>
												...
												You can launch a devastating
												slam attack by right-clicking,
												capable of smashing bones in one
												strike. Great for preventing the
												escape of your victims, as their
												wounds will slow them.
											</Stack.Item>
										</Stack>
									</Section>
								</Stack.Item>
