						...
						{tray_data && (
							<LabeledList.Item label="Age">
								...
								>
									...
									{seed_data.lifespan * data.cycle_seconds}{' '}
									seconds
								</ProgressBar>
							</LabeledList.Item>
						)}
	...
	return (
		<>
			...
			{!!seed_data.mutatelist.length && (
				<Tooltip
					content={`Mutates into: ${seed_data.mutatelist.join(', ')}`}
				>
					<Icon name="dna" m={0.5} />
				</Tooltip>
			)}
			...
			{!!seed_data.distill_reagent && (
				<Tooltip
					content={`Ferments into: ${seed_data.distill_reagent}`}
				>
