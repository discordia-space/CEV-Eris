...
export class IntegratedCircuit extends Component {
	constructor(props) {
		...
		this.handleMouseDownComponent =
			this.handleMouseDownComponent.bind(this);
					...
					{!!componentMenuOpen && (
						...
						>
							<ComponentMenu
								components={
									(stored_designs &&
										Object.keys(stored_designs)) ||
									[]
								}
								onClose={(event) =>
									this.setState({ componentMenuOpen: false })
								}
