...
const ScanSelectionSection = (props) => {
	...
	const point_cost =
		scan_power > 0 ? formatTime(point_scan_eta, 'short') : '∞';
					...
					<Section fill title="Scans">
						{!point_scan_complete && (
							<Section title="Point Scan">
								<BlockQuote>
									Point scan performs rudimentary scan of the
									site, revealing its general characteristics.
								</BlockQuote>
								<Box>
									<Button
										content="Scan"
						...
						{!deep_scan_complete && (
							<Section title="Deep Scan">
								<BlockQuote>
									Deep scan performs full scan of the site,
