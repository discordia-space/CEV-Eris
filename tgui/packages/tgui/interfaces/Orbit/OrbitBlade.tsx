	...
	return (
		<Stack vertical width="244px">
			<Stack.Item>
				...
				>
					Keep in mind: Orbit does not update automatically. You will
					need to click the &quot;Refresh&quot; button to see the
					latest data.
				</Section>
			</Stack.Item>
			<Stack.Item>
			...
			<Stack.Item>
				...
				>
					...
					roundstart jobs insteas of being based on their worn ID. If
					the person lacks a roundstart job, it will still display
					their ID job icon.
				</Section>
			</Stack.Item>
			{!!orbiting && (
