				...
				<Section scrollable fill>
					<Stack vertical textColor="green">
						<Stack.Item textAlign="center" fontSize="20px">
							...
							<br />A{' '}
							<span style={ninja_emphasis}> SPACE NINJA</span>!
						</Stack.Item>
						<Stack.Item textAlign="center" italic>
							Surprise is my weapon. Shadows are my armor. Without
							them, I am nothing.
						</Stack.Item>
						<Stack.Item>
							<Section fill>
								Your advanced ninja suit contains many powerful
								modules.
								<br /> It can be recharged by right clicking on
								station APCs or other power sources, in order to
								drain their battery.
								<br />
								Right clicking on some kinds of machines or
								items wearing your suit will hack them, to
								varying effect. Experiment and find out what you
								can do!
							</Section>
						</Stack.Item>
						<Stack.Item>
