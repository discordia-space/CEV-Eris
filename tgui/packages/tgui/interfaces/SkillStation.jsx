...
export const InsertedSkillchip = (props) => {
	...
	if (!skillchip_ready) {
		return (
			!working && <NoticeBox info>Please insert a skillchip.</NoticeBox>
		);
	}
				...
				<Stack.Item grow basis={0}>
					<LabeledList>
						...
						<LabeledList.Item label="Slot Size">
							<Box
								color={
									slots_used + slot_use > slots_max && 'red'
								}
							>
								<Icon
									name="save"
					...
					{current.map((skill) => (
						<Table.Row key={skill.ref}>
							...
							<Table.Cell
								...
								color={
									(!!skill.active && 'good') ||
									(skill.complexity + complexity_used >
										complexity_max &&
										'bad') ||
									'grey'
								}
				...
				{!!working && (
					<NoticeBox danger>
						<Flex direction="column">
							<Flex.Item mb={0.5}>
								Operation in progress. Please do not leave the
								chamber.
							</Flex.Item>
							<Flex.Item>
