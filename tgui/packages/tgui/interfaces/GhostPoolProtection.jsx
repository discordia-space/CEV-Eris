		...
		>
			<Window.Content>
				<Flex grow={1} height="100%">
					...
					>
						<NoticeBox danger>
							For people creating a sneaky event: If you toggle
							Station Created Sentience, people may catch on that
							admins have disabled roles for your event...
						</NoticeBox>
						<Flex.Item>
							<Button
								fluid
								...
								onClick={() =>
									act('toggle_events_or_midrounds')
								}
							/>
						</Flex.Item>
						<Flex.Item>
