							...
							seeds.map((item) => (
								...
								>
									...
									>
										...
										{!!item.juice_name && (
											<Tooltip
												content={`Juicing result: ${item.juice_name}`}
											>
												<Icon
													name="glass-water"
													m={0.5}
			...
			content={
				<Table>
					{!!props.grafting && (
						<Table.Row>
							<Table.Cell pb={1}>
								Graft gains the following trait:
							</Table.Cell>
						</Table.Row>
					)}
					<Table.Row header>
