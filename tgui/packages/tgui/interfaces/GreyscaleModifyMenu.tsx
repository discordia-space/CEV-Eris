				...
				{colors.map((item) => (
					...
					>
						...
						<Button
							icon="palette"
							onClick={() =>
								act('pick_color', { color_index: item.index })
							}
						...
						<Button
							icon="dice"
							onClick={() =>
								act('random_color', { color_index: item.index })
							}
				...
				<Flex direction="column">
					...
					<Flex.Item>
						...
						<Button.Checkbox
							...
							disabled={
								!data.generate_full_preview && !data.unlocked
							}
