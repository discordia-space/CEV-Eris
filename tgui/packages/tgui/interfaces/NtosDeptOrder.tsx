				...
				<Stack fill vertical>
					<Stack.Item>
						<NoticeBox info>
							...
							here are completely free of charge, only incurring a
							cooldown on the service. Cheaper items will make you
							wait for less time before Nanotrasen allows another
			...
			<Stack vertical>
				...
				<Stack.Item textAlign="center" fontSize="14px" color="red">
					<Button disabled={!id_inside} onClick={() => act('link')}>
						Please insert a silver Head of Staff ID and press to
						continue.
					</Button>
				</Stack.Item>
			</Stack>
