		...
		<LabeledList>
			<LabeledList.Item label="Affects">
				...
				<Button
					icon="flask"
					color={
						selectedBitflags & bitflags.CHEMICAL ? 'green' : 'red'
					}
					onClick={() => {
			...
			<LabeledList.Item label="Type">
				...
				<Button
					color={
						selectedBitflags & bitflags.HEALING ? 'green' : 'red'
					}
					icon="medkit"
					onClick={() => {
				...
				<Button
					...
					color={
						selectedBitflags & bitflags.DAMAGING ? 'green' : 'red'
					}
					onClick={() => {
				...
				<Button
					icon="bomb"
					color={
						selectedBitflags & bitflags.EXPLOSIVE ? 'green' : 'red'
					}
					onClick={() => {
			...
			<LabeledList.Item label="Difficulty">
				...
				<Button
					icon="chess-knight"
					color={
						selectedBitflags & bitflags.MODERATE ? 'green' : 'red'
					}
					onClick={() => {
				...
				<Button
					...
					color={
						selectedBitflags & bitflags.DANGEROUS ? 'green' : 'red'
					}
					onClick={() => {
				...
				<Button
					icon="recycle"
					color={
						selectedBitflags & bitflags.COMPETITIVE
							? 'green'
							: 'red'
					}
					onClick={() => {
