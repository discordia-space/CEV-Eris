	...
	return (
		...
		>
			<NoticeBox info textAlign="center">
				The lobby currently has {readyGhosts ? readyGhosts.length : '0'}
				/12 valid players signed up.
			</NoticeBox>
			{!!is_observer && (
				<NoticeBox color="green" textAlign="center">
					Players who sign up for Mafia while dead will be returned to
					their bodies after the game finishes, allowing you to
					temporarily exit to play a match.
				</NoticeBox>
			)}
					...
					>
						<Stack align="center">
							<Stack.Item
								...
								backgroundColor={
									player.ref === person_voted_up_ref
										? 'yellow'
										: null
								}
							>
		...
		<Collapsible title="ADMIN CONTROLS" color="red">
			<Section>
				<Collapsible title="A kind, coder warning" color="transparent">
					Almost all of these are all built to help me debug the game
					(ow, debugging a 12 player game!) So they are rudamentary
					and prone to breaking at the drop of a hat. Make sure you
					know what you&apos;re doing when you press one. Also because
					an admin did it: do not gib/delete/dust anyone! It will
					runtime the game to death
				</Collapsible>
