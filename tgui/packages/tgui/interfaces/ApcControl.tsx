				...
				<Stack.Item grow>
					<Stack fill vertical justify="center" align="center">
						...
						<Stack.Item color="label">
							Copyright 2526 Nanotrasen
						</Stack.Item>
					</Stack>
				</Stack.Item>
				<Stack.Item color="#2a2a2a">
					Nanotrasen and its affiliates do not endorse this product.
					Risk of serious bodily injury or death is inherent in the
					use of any device that generates electricity. Nanotrasen is
					not responsible for any damages caused by the use of this
					product.
				</Stack.Item>
				<Stack.Item>
					<NoticeBox
