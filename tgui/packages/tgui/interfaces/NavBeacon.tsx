			...
			<LabeledList>
				...
				<LabeledList.Item label="Enable as Patrol Beacon">
					<Button.Checkbox
						...
						content={
							controls.patrol_enabled ? 'Enabled' : 'Disabled'
						}
						disabled={props.disabled}
				...
				<LabeledList.Item label="Next patrol">
					<Button
						fluid
						content={
							controls.patrol_next ?? 'No next patrol location'
						}
						icon="pencil-alt"
						disabled={props.disabled}
				...
				<LabeledList.Item label="Enable as Delivery Beacon">
					<Button.Checkbox
						...
						content={
							controls.delivery_enabled ? 'Enabled' : 'Disabled'
						}
						disabled={props.disabled}
