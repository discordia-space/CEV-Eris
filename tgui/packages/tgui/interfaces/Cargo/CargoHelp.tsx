		...
		<Stack fill vertical>
			<Stack.Item grow>
				<Section fill scrollable>
					<Section color="label" title="Department Orders">
						...
						<br />
						<br />
						Examine a department order crate to get specific details
						about where the crate needs to go.
					</Section>
					<Section title="MULEbots">
						<Box color="label">
							MULEbots are slow but loyal delivery bots that will
							get crates delivered with minimal technician effort
							required. It is slow, though, and can be tampered
							with while en route.
						</Box>
						<br />
						...
						<b>1.</b> Drag the crate you want to deliver next to the
						MULEbot.
						<br />
						<b>2.</b> Drag the crate on top of MULEbot. It should
						load on.
						<br />
						<b>3.</b> Open your PDA.
						<br />
					...
					<Section title="Disposals Delivery System">
						...
						<br />
						<b>2.</b> Use the destinations tagger to choose where to
						send it.
						<br />
						<b>3.</b> Tag the package.
						<br />
						<b>4.</b> Stick it on the conveyor and let the system
						handle it.
						<br />
					</Section>
				</Section>
			...
			<Stack.Item>
				<NoticeBox textAlign="center" info mb={0}>
					Pondering something not included here? When in doubt, ask
					the QM!
				</NoticeBox>
			</Stack.Item>
		</Stack>
