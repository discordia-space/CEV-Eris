...
export const PortraitPicker = (props) => {
	...
	const current_portrait_title =
		got_paintings && paintings[listIndex]['title'];
			...
			<Window.Content>
				<Flex height="100%" direction="column">
					...
					<Flex.Item>
						...
						<Flex.Item>
							<NoticeBox danger>
								WARNING: While Central Command loves art as much
								as you do, choosing erotic art will lead to
								severe consequences. Additionally, Central
								Command reserves the right to request you change
								your display portrait, for any reason.
							</NoticeBox>
						</Flex.Item>
					</Flex.Item>
				</Flex>
