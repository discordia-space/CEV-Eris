	...
	return (
		<>
			<Box mb={2}>
				...
				{reverse ? 'does not have' : 'has'} any warrants for their
				arrest.
			</Box>
			<ScannerGateMode />
		</>
...
const ScannerGateGuns = (props) => {
	...
	return (
		<>
			<Box mb={2}>
				Trigger if the person scanned{' '}
				{reverse ? 'does not have' : 'has'} any guns.
			</Box>
			<ScannerGateMode />
		</>
	);
...
const ScannerGateMindshield = (props) => {
	...
	return (
		<>
			<Box mb={2}>
				Trigger if the person scanned{' '}
				{reverse ? 'does not have' : 'has'} a mindshield.
			</Box>
			<ScannerGateMode />
		</>
	);
...
const ScannerGateDisease = (props) => {
	...
	return (
		<>
			<Box mb={2}>
				Trigger if the person scanned{' '}
				{reverse ? 'does not have' : 'has'} a disease equal or worse
				than {disease_threshold}.
			</Box>
			<Box mb={2}>
...
const ScannerGateSpecies = (props) => {
	const { act, data } = useBackend();
	const { reverse, target_species_id, available_species, target_zombie } =
		data;
...
const ScannerGateNutrition = (props) => {
	...
	return (
		<>
			<Box mb={2}>
				Trigger if the person scanned{' '}
				{reverse ? 'does not have' : 'has'} the {nutrition.name}{' '}
				nutrition level.
			</Box>
			<Box mb={2}>
