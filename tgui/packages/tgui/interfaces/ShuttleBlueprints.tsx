...
const DirectionPad = (props: DirectionPadProps) => {
	...
	return (
		<Section
			...
			title={
				tooltip ? (
					<Tooltip content={tooltip}>{titleNode}</Tooltip>
				) : (
					titleNode
				)
			}
			...
			<Stack.Item width="100%">
				<Stack fill justify="center">
					...
					<Stack.Item>
						<Button.Confirm
							disabled={
								!(onShuttle && inDefaultArea && mergeArea) ||
								mergeApcConflict
							}
							tooltip={
