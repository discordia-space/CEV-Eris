				...
				>
					<NoticeBox info>
						<Collapsible title="Instructions" color="blue">
							Buy orders for material sheets placed here will be
							ordered on the next cargo shipment.
							<br /> <br />
							To sell materials, please insert sheets or similar
							stacks of materials. All minerals sold on the market
							directly are subject to a scaling value decrease per
							material, but this will recover over time. To
							prevent market manipulation, all registered traders
							can buy a total of 10 full stacks of materials at a
							time.
							<br /> <br />
							All new purchases will include the cost of the
							shipped crate, which may be recycled afterwards.
						</Collapsible>
					</NoticeBox>
					<Section>
						<Stack>
							...
							<Stack.Item
								width="20%"
								color={
									data.updateTime > 150 ? 'green' : '#ad7526'
								}
							>
								<b>
									{Math.round(data.updateTime / 10)} seconds
								</b>{' '}
								until next update
							</Stack.Item>
							<Stack.Item>
								...
								<Stack.Item width="75%">
									<Stack>
										...
										<Stack.Item width="15%" pr="2%">
											Trading at{' '}
											<b>{formatMoney(material.price)}</b>{' '}
											cr.
										</Stack.Item>
										{material.price < material.threshold ? (
											...
											<Stack.Item width="33%" ml={2}>
												...
												sheets of <b>{material.name}</b>{' '}
												trading.{' '}
												{material.requested || 'Zero'}{' '}
												sheets ordered.
											</Stack.Item>
										)}
										...
										>
											<b>{toTitleCase(material.name)}</b>{' '}
											is trending <b>{material.trend}</b>.
										</Stack.Item>
									</Stack>
								</Stack.Item>
								<Stack.Item>
