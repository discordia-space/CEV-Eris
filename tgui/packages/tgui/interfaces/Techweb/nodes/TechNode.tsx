					...
					{costs.map((k) => {
						...
						return (
							<Stack.Item key={k.type} grow basis={0}>
								...
								>
									{point_types_abbreviations[k.type]} (
									{nodeProg}/{reqPts})
								</ProgressBar>
							</Stack.Item>
						);
						...
						return (
							<Experiment key={thisExp} exp={thisExp}>
								<Box className="Techweb__ExperimentDiscount">
									...
									{discount_experiments[k]} points to all
