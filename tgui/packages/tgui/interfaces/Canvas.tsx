...
export const Canvas = (props) => {
	...
	const griddy =
		!!data.show_grid && !!data.editable && !!data.paint_tool_color;
						...
						<Flex.Item>
							<PaintCanvas
								...
								onCanvasModifiedHandler={(changed) =>
									act('paint', {
										data: toMassPaintFormat(changed),
									})
								}
									...
									(element, index) => (
										<Button
											...
											style={{
												...
												height: '24px',
												borderStyle: 'solid',
												borderColor: element.is_selected
													? 'lightblue'
													: 'black',
												borderWidth: '2px',
											}}
