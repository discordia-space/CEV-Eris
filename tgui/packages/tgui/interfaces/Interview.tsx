					...
					{!read_only && (
						<>
							<Box as="p" color="label">
								...
								<ul>
									<li>
										You can press enter key or the save
										button to save an answer.
									</li>
									<li>
										You can edit your answers until you
							...
							<NoticeBox info align="center">
								You will not be able to edit your answers after
								submitting.
							</NoticeBox>
						</>
					)}
...
const RenderedStatus = (props: { status: string; queue_pos: number }) => {
	...
	switch (status) {
		...
		default:
			return (
				<NoticeBox info>
					Your answers have been submitted. You are position{' '}
					{queue_pos} in queue.
				</NoticeBox>
			);
	}
