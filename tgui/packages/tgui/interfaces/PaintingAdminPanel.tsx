			...
			<Window.Content scrollable>
				{chosenPainting && (
					<Section
						...
						buttons={
							<Button
								onClick={() => setChosenPaintingRef(undefined)}
							>
								Close
							</Button>
						}
					>
						...
						<Section title="Actions">
							...
							<Button
								onClick={() =>
									act('dumpit', { ref: chosenPainting.ref })
								}
							>
								Reset Patronage
							</Button>
						...
						{paintings.map((painting) => (
							...
							>
								...
								<Table.Cell>
									<Button
										onClick={() =>
											setChosenPaintingRef(painting.ref)
										}
									>
										Edit
									</Button>
