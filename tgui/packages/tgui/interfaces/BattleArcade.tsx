...
const ShopPanel = (props) => {
	...
	return (
		<Section align="center">
			...
			<Box m={2}>
				Feel free to browse our wares, or take a nap. I&apos;ll be here
				to ensure you&apos;ll get a good night&apos;s rest without worry
				of ambushing or robbery.
			</Box>
...
const WorldMapPanel = (props) => {
	...
	return (
		<Section align="center">
			...
			<Box m={1}>
				The further down you go, the harder the enemies will be, but the
				more loot you will get.
			</Box>
			...
			{all_worlds.map((world, index) => (
				<Button
					...
					width="100%"
					onClick={() =>
						act('start_fight', { selected_arena: world })
					}
				>
					{world}
				</Button>
...
const BetweenBattlePanel = (props) => {
	...
	return (
		<Section align="center">
			...
			<Box m={1}>
				As night sets, you can choose to rest. This will restore your
				health and mana to full before the next battle, but you may also
				be ambushed, forcing you into the next fight without any
				additional healing.
			</Box>
			<Button
				icon="bed"
				width="100%"
				onClick={() => act('continue_with_rest')}
			>
				Attempt to sleep
			</Button>
			<Button
