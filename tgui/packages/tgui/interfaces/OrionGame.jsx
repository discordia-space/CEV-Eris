...
const ORION_STATUS_INSTRUCTIONS = (props) => {
	...
	return (
		<>
			...
			>
				<Box fontSize="11px">
					In the 2200&apos;s, the Orion trail was established as a
					dangerous yet opportunistic trail through space for those
					willing to risk it. Many pioneers seeking new lives on the
					galactic frontier would find exactly what they were
					seeking... or lose their lives on the way.
				</Box>
			</Section>
			<Section title="Status Example">
				<Stack>
					...
					<Divider vertical />
					<Stack.Item>
						This is the status panel for your pioneers. Each one
						requires 1 food every time you continue towards{' '}
						<span style={goodstyle}>Orion</span>
						. You can find more crew on your journey, and lose them
						as fast as you found &apos;em.
						<br />
						<br />
			...
			<Section title="Resources">
				<Stack>
					<Stack.Item grow>
						...
						<span style={goodstyle}>Orion</span>, you&apos;ll need
						to manage your resources:
						<br />
						<span style={goodstyle}>Food</span>: Your crewmembers
						consume it. More crew means this goes down faster!
						<br />
						<span style={fuelstyle}>Fuel</span>: You use 5u of fuel
						with every movement. Don&apos;t let it run out.
						<br />
						<span style={partstyle}>Parts</span>: Used to repair
						breakdowns. Nobody likes wasting time on repairs!
					</Stack.Item>
					<Divider vertical />
					<Stack.Item>
						<Stack vertical fill justify="center">
					...
					<Stack fill textAlign="center" vertical>
						<Stack.Item grow>
							<Box bold fontSize="15px">
								{(!!eventname && eventname) ||
									locationInfo[turns - 1].title}
							</Box>
							<br />
							<Box fontSize="15px">
								{(!!eventtext && eventtext) ||
									locationInfo[turns - 1].blurb}
							</Box>
						</Stack.Item>
						<Stack.Item>
							{(!!buttons &&
				...
				>
					<Stack fill textAlign="center" vertical>
						<Stack.Item grow>
							...
							<Box fontSize="14px">
								{(spaceport_raided && (
									<Box color="red">
										You are lucky to have escaped with your
										life. Attempting to dock again would be
										certain death.
									</Box>
								)) ||
                  ...
                  you reach Orion. They aren't free, though!"}
						...
						{(spaceport_raided && (
							<>
								<Stack.Item>
									The Port is under high security. Any
									possibility of purchasing goods has long
									since sailed.
								</Stack.Item>
								<Stack.Item grow />
							</>
									...
									<Stack mb={-1} fill>
										<Stack.Item grow basis={0}>
											<Stack vertical>
												...
												<Stack.Item
													mb={marketButtonSpacing}
												>
													<Button
														fluid
														icon="wrench"
														content={
															'5 Fuel for Hull Plates'
														}
														color="average"
														onClick={() =>
															act('buyparts', {
