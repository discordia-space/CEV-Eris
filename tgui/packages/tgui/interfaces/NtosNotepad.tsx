...
const PartiallyUnderlined = (props: PartiallyUnderlinedProps) => {
	...
	const end =
		indexStart < str.length - 1 ? str.substring(indexStart + 1) : '';
	return (
		<>
			{start}
		...
		<MenuBar>
			...
			>
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('new', 'New')}
				/>
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('save', 'Save')}
				/>
				<MenuBar.Dropdown.Separator key="firstSep" />
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('exit', 'Exit...')}
				/>
			</MenuBar.Dropdown>
			<MenuBar.Dropdown
				entry="edit"
			...
			>
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('cut', 'Cut')}
				/>
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('copy', 'Copy')}
				/>
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('paste', 'Paste')}
				/>
				<MenuBar.Dropdown.MenuItem
					{...getMenuItemProps('delete', 'Delete')}
				/>
			</MenuBar.Dropdown>
			<MenuBar.Dropdown
				entry="format"
			...
			<div className="Dialog__body">
				...
				<Box className="NtosNotepad__AboutDialog__text">
					...
					<span style={{ padding: '3rem 1rem 3rem 2rem' }}>
						The NtOS operating system and its user interface are
						protected by trademark and other pending or existing
						intellectual property rights in the Sol system and other
						regions.
					</span>
					<span
						style={{
					...
					>
						This product is licensed under the NT Corporation Terms
						to:
					</span>
