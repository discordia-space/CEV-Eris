	...
	return (
		<Section align="left">
			...
			{!!historian_mode && !!holographic_showpiece && (
				<Box>
					A holographic trophy is already present. Replace it with a
					new trophy to create a new recording.
				</Box>
			)}
			{!!historian_mode && !has_showpiece && (
				<Box>No trophies located.</Box>
			)}
			{!!historian_mode &&
				!!has_showpiece &&
				!holographic_showpiece &&
				!!showpiece_description && (
					<Box>
						Recording has begun. Trophy data will be saved
						overnight, as long as the trophy stays within an intact
						case.
					</Box>
				)}
			{!!historian_mode &&
				...
				!showpiece_description && (
					<Box>
						New trophy detected. Please record a description to
						begin archival.
					</Box>
				)}
		</Section>
		...
		<Section fill align="center">
			{!has_showpiece && (
				<Box fill className="Trophycase-description">
					<b>
						This exhibit is empty. History awaits your contribution!
					</b>
				</Box>
			)}
