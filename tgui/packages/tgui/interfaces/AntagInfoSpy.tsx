				...
				<Section title={`You are the ${antag_name || 'Spy'}.`}>
					<Stack vertical fill ml={1} mr={1}>
						<Stack.Item fontSize={1.2}>
							You have been equipped with a special uplink device
							disguised as {uplink_location || 'something'} that
							will allow you to steal from the station.
						</Stack.Item>
						<Stack.Item>
							<span style={greenText}>
								<b>Use it in hand</b> to access your uplink, and{' '}
								<b>right click</b> on bounty targets to steal
								them.
							</span>
						</Stack.Item>
						<Stack.Divider />
						<Stack.Item>
							You may not be alone: There may be other spies on
							the station.
						</Stack.Item>
						<Stack.Item>
							Work together or work against them: The choice is
							yours, but{' '}
							<span style={redText}>
