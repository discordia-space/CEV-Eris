...
const TAB2NAME: TabType[] = [
	...
	{
		title: 'Perks',
		blurb: 'Perks are useful (and not so useful) improvements to the soul and body collected from all corners of the universe.',
		scrollable: true,
	},
	{
		title: 'Table of Contents',
...
const Randomize = (props) => {
	...
	return (
		<Stack fill vertical>
			{points < 10 && <PointLocked />}
			<Stack.Item>
				Semi-Randomize will ensure you at least get some mobility and
				lethality. Guaranteed to have {semi_random_bonus} points worth
				of spells.
			</Stack.Item>
			<Stack.Item>
				<Button.Confirm
			...
			<Stack.Item>
				Full Random will give you anything. There&apos;s no going back,
				either! Guaranteed to have {full_random_bonus} points worth of
				spells.
			</Stack.Item>
			<Stack.Item>
				<NoticeBox danger>
...
const SpellTabDisplay = (props: {
	...
	return (
		<Stack vertical>
			{TabSpells.sort((a, b) => a.name.localeCompare(b.name)).map(
				(entry) => (
