			...
			<Window.Content>
				<Section scrollable fill>
					<Stack fill vertical>
						...
						<Stack.Item mb={1}>
							<span style={textStyles.danger}>Bitrunning</span> is
							a crime. Your mission:{' '}
							<span style={textStyles.variable}>Eliminate</span>{' '}
							organic intruders to maintain the integrity of the
							system.
						</Stack.Item>
						<SpecificInfo />
						...
						<Stack.Item>
							const{' '}
							<span style={textStyles.variable}>TARGETS</span>{' '}
							={' '}
						</Stack.Item>
						<Stack.Item>
	...
	switch (antag_name) {
		case 'Cyber Police':
			return (
				<>
					<Stack.Item mb={1}>
						To assist your task, your program has been loaded with
						cutting edge{' '}
						<span style={textStyles.variable}>martial arts</span>{' '}
						skills.
					</Stack.Item>
					<Stack.Item grow>
						Ranged weaponry is{' '}
						<span style={textStyles.danger}>forbidden</span>.
		...
		case 'Cyber Tac':
			return (
				<>
					<Stack.Item mb={1}>
						You are an advanced combat unit. You have been outfitted
						with{' '}
						<span style={textStyles.variable}>lethal weaponry</span>
						.
					</Stack.Item>
					<Stack.Item grow>
						<span style={textStyles.danger}>Terminate</span> organic
						life at any cost.
					</Stack.Item>
				</>
			);
