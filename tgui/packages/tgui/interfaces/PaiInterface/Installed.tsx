			...
			<Stack.Item grow>
				<Section fill scrollable title={title}>
					{currentSelection && (
						<Stack fill vertical>
							<Stack.Item>
								{SOFTWARE_DESC[currentSelection]}
							</Stack.Item>
							<Stack.Item grow>
								<SoftwareButtons
			...
			return (
				<>
					<Button
						...
						icon="plug"
						onClick={() =>
							act(currentSelection, { mode: DOOR_JACK.Cable })
						}
					...
					<Button
						...
						icon="door-open"
						onClick={() =>
							act(currentSelection, { mode: DOOR_JACK.Hack })
						}
					...
					<Button
						...
						icon="unlink"
						onClick={() =>
							act(currentSelection, { mode: DOOR_JACK.Cancel })
						}
					>
						Cancel
					</Button>
			...
			return (
				<>
					<Button
						...
						onClick={() =>
							act(currentSelection, { mode: HOST_SCAN.Target })
						}
					...
					<Button
						...
						icon="user-cog"
						onClick={() =>
							act(currentSelection, { mode: HOST_SCAN.Master })
						}
			...
			return (
				<>
					<Button
						icon="camera-retro"
						onClick={() =>
							act(currentSelection, { mode: PHOTO_MODE.Camera })
						}
					...
					<Button
						icon="print"
						onClick={() =>
							act(currentSelection, { mode: PHOTO_MODE.Printer })
						}
					...
					<Button
						icon="search-plus"
						onClick={() =>
							act(currentSelection, { mode: PHOTO_MODE.Zoom })
						}
