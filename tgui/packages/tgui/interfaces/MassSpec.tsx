							...
							<>
								{
									<Box inline color="label" mr={2}>
										{beaker1.currentVolume} /{' '}
										{beaker1.maxVolume} units
									</Box>
								}
								<Button
									icon="eject"
					...
					buttons={
						!!beaker2 && (
							<>
								{
									<Box inline color="label" mr={2}>
										{beaker2.currentVolume} /{' '}
										{beaker2.maxVolume} units
									</Box>
								}
								<Button
									icon="eject"
				...
				(beaker.contents.length === 0 && (
					...
					<Table className="candystripe">
						...
						{beaker.contents.map((reagent) => {
							const selected =
								reagent.mass >= lowerRange &&
								reagent.mass <= upperRange;
							const color =
								reagent.type === 'Inverted'
									? '#b60046'
									: '#3cf096';
	...
	return (
		...
		>
			...
			<Slider
				...
				width={
					base_width -
					(centerValue / graphUpperRange) * base_width +
					'px'
				}
				value={upperRange}
