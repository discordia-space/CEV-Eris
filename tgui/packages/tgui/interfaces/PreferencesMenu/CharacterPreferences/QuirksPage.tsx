					...
					>
						<QuirkList
							...
							onClick={(quirkName, quirk) => {
								if (
									getReasonToNotAdd(quirkName) !== undefined
								) {
									return;
								}

								setSelectedQuirks(
									selectedQuirks.concat(quirkName),
								);
							...
							quirks={quirks
								.filter(([quirkName, _]) => {
									return (
										selectedQuirks.indexOf(quirkName) ===
											-1 &&
				...
				<Stack vertical fill align="center">
					...
					>
						<QuirkList
							...
							onClick={(quirkName, quirk) => {
								if (
									getReasonToNotRemove(quirkName) !==
									undefined
								) {
									return;
								}
